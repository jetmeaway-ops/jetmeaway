  ...
  const faqSchema = {
    ...
    mainEntity: [
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'Yes — both flights and hotels book directly through JetMeAway. You search, compare and pay all in one place. Your hotel confirmation and flight e-ticket land in your inbox instantly. No redirects, no hidden fees. For holiday packages we route you to our trusted affiliate partners to complete your booking with full ATOL financial protection.',
        },
      },
      {
        '@type': 'Question',
      ...
      },
      {
        ...
        acceptedAnswer: {
          '@type': 'Answer',
          text: 'It depends on how you booked. Hotel booked on JetMeAway: contact us directly at contact@jetmeaway.co.uk — we handle your cancellation, change or refund directly. Flight booked on JetMeAway: contact us directly at contact@jetmeaway.co.uk — we will issue your refund or manage your change request. Holiday package booked via a partner: contact the provider first (Expedia or Trip.com); if they are unresponsive, email us and we will help you escalate.',
        },
      },
      {
        '@type': 'Question',
      ...
      <div className="max-w-[720px] mx-auto px-5 pb-16">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div className="bg-white border border-[#F1F3F7] rounded-3xl p-7 space-y-5">
            ...
            <InfoItem icon="fa-shield-halved" title="Booking Queries" desc={<span className="text-[.78rem] text-[#8E95A9]">For hotels and flights booked directly on JetMeAway, email <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold hover:underline">contact@jetmeaway.co.uk</a> and we will help you directly. For holiday packages booked via our affiliate partners, please contact the provider first — then come to us if they are unresponsive.</span>} />
          </div>
            ...
            {!sent ? (
              <>
                ...
                <div className="space-y-3">
                  <div><label htmlFor="cf-name" className="block text-[.58rem] font-bold uppercase tracking-[1.5px] text-[#8E95A9] mb-1">Your Name</label><input id="cf-name" type="text" placeholder="John Smith" className="w-full p-3 bg-[#F8FAFC] border border-[#E4E8F0] rounded-lg text-[.88rem] text-[#1A1D2B] outline-none focus:border-[#0066FF]" /></div>
                  <div><label htmlFor="cf-email" className="block text-[.58rem] font-bold uppercase tracking-[1.5px] text-[#8E95A9] mb-1">Email</label><input id="cf-email" type="email" placeholder="your@email.com" className="w-full p-3 bg-[#F8FAFC] border border-[#E4E8F0] rounded-lg text-[.88rem] text-[#1A1D2B] outline-none focus:border-[#0066FF]" /></div>
                  <div><label htmlFor="cf-subject" className="block text-[.58rem] font-bold uppercase tracking-[1.5px] text-[#8E95A9] mb-1">Subject</label><select id="cf-subject" className="w-full p-3 bg-[#F8FAFC] border border-[#E4E8F0] rounded-lg text-[.88rem] text-[#1A1D2B] outline-none"><option>General Enquiry</option><option>Feedback</option><option>Report a Problem</option><option>Partnership</option></select></div>
                  <div><label htmlFor="cf-msg" className="block text-[.58rem] font-bold uppercase tracking-[1.5px] text-[#8E95A9] mb-1">Message</label><textarea id="cf-msg" placeholder="How can we help?" className="w-full p-3 bg-[#F8FAFC] border border-[#E4E8F0] rounded-lg text-[.88rem] text-[#1A1D2B] outline-none focus:border-[#0066FF] min-h-[120px] resize-y" /></div>
        ...
        <div className="bg-white border border-[#F1F3F7] rounded-3xl p-7 mt-4">
          ...
          <div className="space-y-3.5">
            ...
            <FAQ q="Can I book a flight or hotel directly on JetMeAway?" a={`Yes — both flights and hotels book directly through JetMeAway. You search, compare and pay all in one place. Your hotel confirmation and flight e-ticket land in your inbox instantly. No redirects, no hidden fees.\n\nFor holiday packages we route you to our trusted affiliate partners to complete your booking with full ATOL financial protection.`} />
            ...
            <FAQ q="Who do I contact if I have a problem with my booking?" a={`It depends on how you booked:\n\n🏨 Hotel booked on JetMeAway — contact us directly at contact@jetmeaway.co.uk. We handle your cancellation, change or refund directly.\n\n✈️ Flight booked on JetMeAway — contact us directly at contact@jetmeaway.co.uk. We will issue your refund or manage your change request.\n\n📦 Holiday package booked via a partner — contact the provider first (Expedia or Trip.com). If they are unresponsive, email us and we will help you escalate.`} />
