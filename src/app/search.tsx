    ...
    <div className="max-w-[680px] mx-auto w-full">
      ...
      <div ref={ref}
        ...
        <button type="button" onMouseDown={submitSearch}
          aria-label={t('go')}
          className="flex-shrink-0 flex items-center justify-center gap-1.5 px-3.5 sm:px-5 py-2.5 sm:py-3 rounded-xl bg-[#0066FF] hover:bg-[#0052CC] text-white font-poppins font-bold text-[.78rem] sm:text-[.85rem] uppercase tracking-wider shadow-[0_4px_16px_rgba(0,102,255,0.25)] hover:shadow-[0_12px_28px_-6px_rgba(0,102,255,0.8)] transition-all">
