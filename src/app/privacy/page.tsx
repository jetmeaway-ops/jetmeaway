    ...
    <>
      ...
      <div className="max-w-[760px] mx-auto px-5 pb-16">
        <div className="bg-white border border-[#F1F3F7] rounded-3xl p-8 text-[.85rem] text-[#5C6378] leading-relaxed space-y-1">
          ...
          <p><strong>JETMEAWAY LTD</strong> (Company No: 17140522), registered at 66 Paul Street, London, United Kingdom (&ldquo;<strong>Jetmeaway</strong>&rdquo;, &ldquo;<strong>we</strong>&rdquo;, &ldquo;<strong>us</strong>&rdquo;) is the <strong>data controller</strong> for personal data processed through <strong>jetmeaway.co.uk</strong> and the JetMeAway mobile application (together, the &ldquo;<strong>Platform</strong>&rdquo;). You can contact us at <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold">contact@jetmeaway.co.uk</a> or <a href="tel:+441174630606" className="text-[#0066FF] font-bold">0117 463 0606</a>. For data-protection enquiries specifically, please write &ldquo;Data Protection&rdquo; in the subject line.</p>
          ...
          <p>If you believe we have not complied with your rights, you may complain to the UK Information Commissioner&apos;s Office at <strong>ico.org.uk</strong> or 0303 123 1113. We would prefer the chance to resolve your concern first.</p>
          ...
          <p>For any privacy question or to exercise any right under this policy, email <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold">contact@jetmeaway.co.uk</a>, call <a href="tel:+441174630606" className="text-[#0066FF] font-bold">0117 463 0606</a>, or write to: JETMEAWAY LTD, 66 Paul Street, London, United Kingdom.</p>
        </div>
      </div>
      <Footer />
    </>
