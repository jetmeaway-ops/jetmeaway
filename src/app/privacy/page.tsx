    ...
    <>
      ...
      <div className="max-w-[720px] mx-auto px-5 pb-16">
        <div className="bg-white border border-[#F1F3F7] rounded-3xl p-8 text-[.85rem] text-[#5C6378] leading-relaxed space-y-1">
          ...
          <p>JETMEAWAY LTD (Company No: 17140522) is a travel comparison website registered at 66 Paul Street, London, United Kingdom. Contact: <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold">contact@jetmeaway.co.uk</a>.</p>
          ...
          <p>To exercise these rights, email <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold">contact@jetmeaway.co.uk</a>.</p>
