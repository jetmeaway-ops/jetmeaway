...
const LANDMARK_ALIASES: Array<{
  ...
  { match: /stonehenge/i, label: 'Stonehenge', sublabel: 'Hotels in Salisbury · nearest town (~15 min drive)', searchAs: 'Salisbury', placeId: 'ChIJt5sANlWMc0gRBqpe8oDgow0' },
  ...
  { match: /cliffs?\s*of\s*moher/i, label: 'Cliffs of Moher', sublabel: 'Hotels in Galway · nearest city (~1h drive)', searchAs: 'Galway', placeId: 'ChIJ_1stWpWTW0gRgVJJCkQbKwM' },
  ...
  { match: /york\s*minster/i, label: 'York Minster', sublabel: 'Hotels in central York', searchAs: 'York', placeId: 'ChIJ8WWY4UDDeEgR0eRUiomrdEc' },
  { match: /hadrian'?s?\s*wall/i, label: "Hadrian's Wall", sublabel: 'Hotels in Hexham · best base for the wall', searchAs: 'Hexham', placeId: 'ChIJFZgxDWKQfUgRBMANIXgrOqg' },
  // --- France ---
  ...
  // --- Italy ---
  { match: /colosseum|coliseum/i, label: 'Colosseum', sublabel: 'Hotels in central Rome', searchAs: 'Rome', placeId: 'ChIJu46S-ZZhLxMROG5lkwZ3D7k' },
  { match: /trevi\s*fountain|fontana\s*di\s*trevi/i, label: 'Trevi Fountain', sublabel: 'Hotels in central Rome', searchAs: 'Rome', placeId: 'ChIJu46S-ZZhLxMROG5lkwZ3D7k' },
  { match: /leaning\s*tower\s*of\s*pisa|tower\s*of\s*pisa/i, label: 'Leaning Tower of Pisa', sublabel: 'Hotels in Pisa', searchAs: 'Pisa', placeId: 'ChIJj1n28JqR1RIRyHiEp7UPuKo' },
  // --- Spain ---
  { match: /alhambra/i, label: 'Alhambra', sublabel: 'Hotels in Granada', searchAs: 'Granada', placeId: 'ChIJfcIyLeb8cQ0Rcg1g0533WJI' },
  ...
  { match: /neuschwanstein/i, label: 'Neuschwanstein Castle', sublabel: 'Hotels in Füssen · gateway to the castle', searchAs: 'Füssen', placeId: 'ChIJCfRmaIBfnEcRAPOL161IHgQ' },
  { match: /cologne\s*cathedral|k(o|ö)lner\s*dom/i, label: 'Cologne Cathedral', sublabel: 'Hotels in central Cologne', searchAs: 'Cologne', placeId: 'ChIJ5S-raZElv0cR8HcqSvxgJwQ' },
  ...
  // --- Turkey ---
  { match: /hagia\s*sophia|ayasofya/i, label: 'Hagia Sophia', sublabel: 'Hotels in central Istanbul (Sultanahmet)', searchAs: 'Istanbul', placeId: 'ChIJawhoAASnyhQR0LABvJj-zOE' },
  { match: /blue\s*mosque|sultan\s*ahmed\s*mosque/i, label: 'Blue Mosque', sublabel: 'Hotels in central Istanbul (Sultanahmet)', searchAs: 'Istanbul', placeId: 'ChIJawhoAASnyhQR0LABvJj-zOE' },
  { match: /cappadocia|kapadokya/i, label: 'Cappadocia', sublabel: 'Hotels in Göreme · centre of the region', searchAs: 'Göreme', placeId: 'ChIJq9Fr03loKhURUK4_ohdObEY' },
  // --- UAE ---
  ...
  // --- Africa ---
  { match: /serengeti/i, label: 'Serengeti', sublabel: 'Hotels in Arusha · gateway to the parks', searchAs: 'Arusha', placeId: 'ChIJg3M48ogcNxgRUnFJ7PcHGbw' },
  { match: /mount\s*kilimanjaro|kilimanjaro/i, label: 'Mount Kilimanjaro', sublabel: 'Hotels in Moshi · base for climbs', searchAs: 'Moshi', placeId: 'ChIJhWOFQ7TZORgRz7zYYwzVhBU' },
  { match: /pyramids?\s*of\s*giza|great\s*pyramid/i, label: 'Pyramids of Giza', sublabel: 'Hotels in Giza · steps from the plateau', searchAs: 'Giza', placeId: 'ChIJl5ZXNZJGWBQRUvx4mB_WkU4' },
  { match: /sahara\s*desert/i, label: 'Sahara Desert (Merzouga)', sublabel: 'Hotels & camps in Merzouga · Erg Chebbi dunes', searchAs: 'Merzouga', placeId: 'ChIJ5d80mCc8lw0RREretbL6OVY' },
  // --- China ---
  ...
  // --- Japan ---
  { match: /mount\s*fuji|mt\.?\s*fuji|fuji\s*san/i, label: 'Mount Fuji', sublabel: 'Hotels in Fujikawaguchiko · classic Fuji-view base', searchAs: 'Fujikawaguchiko', placeId: 'ChIJGyRHiGvgG2ARRmIMgHRWc1w' },
  ...
  { match: /kyoto\s*bamboo|arashiyama\s*bamboo/i, label: 'Arashiyama Bamboo Forest', sublabel: 'Hotels in central Kyoto', searchAs: 'Kyoto', placeId: 'ChIJ8cM8zdaoAWARPR27azYdlsA' },
  // --- Southeast Asia ---
  { match: /petronas\s*towers/i, label: 'Petronas Twin Towers', sublabel: 'Hotels in central Kuala Lumpur (KLCC)', searchAs: 'Kuala Lumpur', placeId: 'ChIJ5-rvAcdJzDERfSgcL1uO2fQ' },
  { match: /angkor\s*wat/i, label: 'Angkor Wat', sublabel: 'Hotels in Siem Reap · gateway to the temples', searchAs: 'Siem Reap', placeId: 'ChIJeaiRjJoWEDER-rvlPvmqQKk' },
  { match: /halong\s*bay|h(a|ạ)\s*long\s*bay/i, label: 'Halong Bay', sublabel: 'Hotels in Ha Long city', searchAs: 'Ha Long', placeId: 'ChIJBcqveDxXSjERAThbfWDP5Wc' },
  { match: /^bali$|bali\s*indonesia|ubud|kuta\s*bali|seminyak/i, label: 'Bali', sublabel: 'Hotels in Denpasar · gateway to Bali', searchAs: 'Denpasar', placeId: 'ChIJ24BeDptA0i0RSje5zOg0c-I' },
  // --- Singapore ---
  ...
  // --- Maldives ---
  { match: /^maldives$|maldives\s*islands/i, label: 'Maldives', sublabel: 'Hotels & resorts via Malé · Maldives gateway', searchAs: 'Malé', placeId: 'ChIJ5fXRB1Z-PzsRmRIFWpvp2Io' },
  // --- Nepal ---
  { match: /mount\s*everest|mt\.?\s*everest|everest\s*base\s*camp/i, label: 'Mount Everest', sublabel: 'Hotels in Kathmandu · start of the trek', searchAs: 'Kathmandu', placeId: 'ChIJv6p7MIoZ6zkR6rGN8Rt8E7U' },
  // --- India ---
  { match: /taj\s*mahal/i, label: 'Taj Mahal', sublabel: 'Hotels in Agra', searchAs: 'Agra', placeId: 'ChIJ2UEvfIUNdDkRQjtSqTjvSng' },
  { match: /^goa$|goa\s*beach|north\s*goa/i, label: 'Goa', sublabel: 'Hotels in Calangute · North Goa beaches', searchAs: 'Calangute', placeId: 'ChIJ9Vm7fePBvzsRhscxtxGXD50' },
  { match: /kerala\s*backwaters|alleppey|alappuzha/i, label: 'Kerala Backwaters', sublabel: 'Hotels in Alleppey · houseboats & lagoons', searchAs: 'Alleppey', placeId: 'ChIJYWspqvGECDsRWvhBLFVkR7g' },
  // --- USA ---
  ...
  { match: /iguazu\s*falls|igua(c|ç)u\s*falls/i, label: 'Iguazu Falls', sublabel: 'Hotels in Foz do Iguaçu · Brazilian side', searchAs: 'Foz do Iguaçu', placeId: 'ChIJQwpTruuQ9pQRUqnEtHOUlyE' },
  // --- Oceania ---
  { match: /great\s*barrier\s*reef/i, label: 'Great Barrier Reef', sublabel: 'Hotels in Cairns · gateway to the reef', searchAs: 'Cairns', placeId: 'ChIJEySiW1VieGkRYHggf_HuAAQ' },
  { match: /uluru|ayers\s*rock/i, label: 'Uluru / Ayers Rock', sublabel: 'Hotels in Yulara · only base for the rock', searchAs: 'Yulara', placeId: 'ChIJPz2rao9AIysRAIUkKqgXAgQ' },
  { match: /hobbiton/i, label: 'Hobbiton', sublabel: 'Hotels in Matamata · gateway to the set', searchAs: 'Matamata', placeId: 'ChIJqRZ64SdObG0RsOGiQ2HvAAU' },
  // === HIDDEN GEMS ===
  { match: /lake\s*bled|^bled$/i, label: 'Lake Bled', sublabel: 'Hotels in Bled · Slovenia\'s alpine lake', searchAs: 'Bled', placeId: 'ChIJYZkT1x2OekcRUOw_ghz4AAQ' },
  { match: /lake\s*como/i, label: 'Lake Como', sublabel: 'Hotels in Como · northern Italy', searchAs: 'Como', placeId: 'ChIJY-0nEEichkcRJPVfeK-Wm7k' },
  { match: /cinque\s*terre|riomaggiore|monterosso/i, label: 'Cinque Terre', sublabel: 'Hotels in Riomaggiore · one of the five villages', searchAs: 'Riomaggiore', placeId: 'ChIJB4uscYn61BIRgGX4h7QPnhE' },
  { match: /faroe\s*islands/i, label: 'Faroe Islands', sublabel: 'Hotels in Tórshavn · capital of the Faroes', searchAs: 'Tórshavn', placeId: 'ChIJlUCZXxwuvEgRqSUCjJgJrt0' },
  { match: /lofoten/i, label: 'Lofoten Islands', sublabel: 'Hotels in Svolvær · main Lofoten town', searchAs: 'Svolvær', placeId: 'ChIJUUNvFyKA3kURMw-2Z5beIIw' },
  { match: /^madeira$|madeira\s*island|madeira\s*portugal/i, label: 'Madeira', sublabel: 'Hotels in Funchal · capital of Madeira', searchAs: 'Funchal', placeId: 'ChIJq4sfUMNfYAwROaHNFSxN2P8' },
  { match: /^azores$|azores\s*islands/i, label: 'Azores', sublabel: 'Hotels in Ponta Delgada · main Azores city', searchAs: 'Ponta Delgada', placeId: 'ChIJlw6wdswqQwsRFsRvTvKAVXY' },
  { match: /antelope\s*canyon|horseshoe\s*bend/i, label: 'Antelope Canyon', sublabel: 'Hotels in Page · gateway to the canyon', searchAs: 'Page', placeId: 'ChIJj3XN_VsTNIcROU44U1EvmG4' },
  ...
  { match: /salar\s*de\s*uyuni|uyuni\s*salt\s*flats/i, label: 'Salar de Uyuni', sublabel: 'Hotels in Uyuni · gateway to the salt flats', searchAs: 'Uyuni', placeId: 'ChIJvfLTWNm6_5MRU2ZOLB6EVRQ' },
  { match: /easter\s*island|rapa\s*nui/i, label: 'Easter Island', sublabel: 'Hotels in Hanga Roa · only town on the island', searchAs: 'Hanga Roa', placeId: 'ChIJFwoxLFP6R5kRDBoGLMq7qpU' },
  { match: /gal(a|á)pagos/i, label: 'Galápagos Islands', sublabel: 'Hotels in Puerto Ayora · main Galápagos town', searchAs: 'Puerto Ayora', placeId: 'ChIJa7-U-0NdqpoRNWGGLDX6QZg' },
  { match: /^fiji$|fiji\s*islands/i, label: 'Fiji', sublabel: 'Hotels in Nadi · main Fiji gateway', searchAs: 'Nadi', placeId: 'ChIJUQgUUYtaF24RKNOlslOphx0' },
  { match: /komodo\s*island|pulau\s*komodo|komodo\s*dragons?/i, label: 'Komodo Island', sublabel: 'Hotels in Labuan Bajo · gateway to Komodo', searchAs: 'Labuan Bajo', placeId: 'ChIJ124xIYpntC0R3RVDNqpeqV4' },
  { match: /raja\s*ampat/i, label: 'Raja Ampat', sublabel: 'Hotels in Waisai · main Raja Ampat town', searchAs: 'Waisai', placeId: 'ChIJC7tdhuojXy0RzmYVplSt3Ng' },
  { match: /^boracay$|boracay\s*island/i, label: 'Boracay', sublabel: 'Hotels in Aklan · gateway to Boracay', searchAs: 'Aklan', placeId: 'ChIJkc4JNwA_pTMR9YmVzK8IcUw' },
  { match: /annapurna|annapurna\s*circuit/i, label: 'Annapurna', sublabel: 'Hotels in Pokhara · base for the trek', searchAs: 'Pokhara', placeId: 'ChIJ_3YDv3uTlTkRZCGAJTuCz_Y' },
  { match: /guilin\s*landscape|yangshuo|li\s*river/i, label: 'Guilin / Yangshuo', sublabel: 'Hotels in Yangshuo · karst landscape', searchAs: 'Yangshuo', placeId: 'ChIJZVKVEX6lpTYRBQDurljkC0c' },
  { match: /^bhutan$|paro\s*valley/i, label: 'Bhutan', sublabel: 'Hotels in Paro · gateway to Bhutan', searchAs: 'Paro', placeId: 'ChIJtzlsWuid4TkRkAEHWg94-gE' },
  { match: /gili\s*islands?|gili\s*trawangan|^lombok$/i, label: 'Gili Islands / Lombok', sublabel: 'Hotels in Lombok · gateway to the Gilis', searchAs: 'Lombok', placeId: 'ChIJBzxUOeI4zC0R286ewj4py_s' },
];
...
function HotelsContent() {
  ...
  const handleSearch = useCallback(async () => {
    ...
    try {
      ...
      // the dropdown row), use that landmark's `searchAs` city so /api/hotels
      // resolves to real hotels instead of falling to Nominatim with the
      // landmark name. Case-insensitivity comes from the alias regex /i flag
      // — but we still lowercase both sides of the equality check so click-set
      // values that already match a `searchAs` don't double-resolve.
