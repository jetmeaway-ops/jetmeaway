...
type PlaceResult = {
  ...
  description: string;
  type: string;
  // Optional — curated neighbourhoods + LANDMARK_ALIASES entries include
  // coordinates + an explicit search radius. When set, /api/hotels does a
  // true lat/lng radius search via LiteAPI instead of the city-name path.
  lat?: number;
  lng?: number;
  radiusKm?: number;
  query?: string;
...
const LANDMARK_ALIASES: Array<{
...
}> = [
  {
    ...
    placeId: 'ChIJ_WegsaCYc0gRlCypaxXgLjs', lat: 50.7220101, lng: -1.8667169, radiusKm: 10,
  },
  {
    ...
    searchAs: 'Paris',
    placeId: 'ChIJveJ6yhkd5kcRYOYQY8v4-Ic', lat: 48.8722, lng: 2.7758, radiusKm: 10,
  },
  // --- UK & Ireland ---
  { match: /big\s*ben|westminster\s*(palace|abbey)?/i, label: 'Big Ben / Westminster', sublabel: 'Hotels in central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 10 },
  { match: /buckingham\s*palace/i, label: 'Buckingham Palace', sublabel: 'Hotels in central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 10 },
  { match: /london\s*eye/i, label: 'London Eye', sublabel: 'Hotels on the South Bank · central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 10 },
  { match: /tower\s*bridge/i, label: 'Tower Bridge', sublabel: 'Hotels in central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 10 },
  { match: /stonehenge/i, label: 'Stonehenge', sublabel: 'Hotels in Salisbury · nearest town (~15 min drive)', searchAs: 'Salisbury', placeId: 'ChIJt5sANlWMc0gRBqpe8oDgow0', lat: 51.068785, lng: -1.794472, radiusKm: 75 },
  { match: /edinburgh\s*castle/i, label: 'Edinburgh Castle', sublabel: 'Hotels in central Edinburgh', searchAs: 'Edinburgh', placeId: 'ChIJIyaYpQC4h0gRJxfnfHsU8mQ', lat: 55.953252, lng: -3.1882669999999997, radiusKm: 10 },
  { match: /loch\s*ness/i, label: 'Loch Ness', sublabel: 'Hotels in Inverness · gateway to the loch', searchAs: 'Inverness', placeId: 'ChIJK94XLVtxj0gRPcQ-LtEJQ2I', lat: 57.477773, lng: -4.224721, radiusKm: 75 },
  { match: /cliffs?\s*of\s*moher/i, label: 'Cliffs of Moher', sublabel: 'Hotels in Galway · nearest city (~1h drive)', searchAs: 'Galway', placeId: 'ChIJ_1stWpWTW0gRgVJJCkQbKwM', lat: 53.274001, lng: -9.051266199999999, radiusKm: 75 },
  { match: /giants?\s*causeway/i, label: "Giant's Causeway", sublabel: 'Hotels in Belfast · nearest city (~1h drive)', searchAs: 'Belfast', placeId: 'ChIJO4rQ1_3_YEgRMcXH7ywWVy4', lat: 54.59728500000001, lng: -5.93012, radiusKm: 75 },
  { match: /york\s*minster/i, label: 'York Minster', sublabel: 'Hotels in central York', searchAs: 'York', placeId: 'ChIJ8WWY4UDDeEgR0eRUiomrdEc', lat: 53.961420499999996, lng: -1.0739108, radiusKm: 10 },
  { match: /hadrian'?s?\s*wall/i, label: "Hadrian's Wall", sublabel: 'Hotels in Hexham · best base for the wall', searchAs: 'Hexham', placeId: 'ChIJFZgxDWKQfUgRBMANIXgrOqg', lat: 54.972665, lng: -2.1121439, radiusKm: 75 },
  // --- France ---
  { match: /eiffel\s*tower|tour\s*eiffel/i, label: 'Eiffel Tower', sublabel: 'Hotels in central Paris', searchAs: 'Paris', placeId: 'ChIJD7fiBh9u5kcRYJSMaMOCCwQ', lat: 48.857547499999995, lng: 2.3513764999999998, radiusKm: 10 },
  // --- Italy ---
  { match: /colosseum|coliseum/i, label: 'Colosseum', sublabel: 'Hotels in central Rome', searchAs: 'Rome', placeId: 'ChIJu46S-ZZhLxMROG5lkwZ3D7k', lat: 41.8967068, lng: 12.4822025, radiusKm: 10 },
  { match: /trevi\s*fountain|fontana\s*di\s*trevi/i, label: 'Trevi Fountain', sublabel: 'Hotels in central Rome', searchAs: 'Rome', placeId: 'ChIJu46S-ZZhLxMROG5lkwZ3D7k', lat: 41.8967068, lng: 12.4822025, radiusKm: 10 },
  { match: /leaning\s*tower\s*of\s*pisa|tower\s*of\s*pisa/i, label: 'Leaning Tower of Pisa', sublabel: 'Hotels in Pisa', searchAs: 'Pisa', placeId: 'ChIJj1n28JqR1RIRyHiEp7UPuKo', lat: 43.722838499999995, lng: 10.4017581, radiusKm: 10 },
  // --- Spain ---
  { match: /alhambra/i, label: 'Alhambra', sublabel: 'Hotels in Granada', searchAs: 'Granada', placeId: 'ChIJfcIyLeb8cQ0Rcg1g0533WJI', lat: 37.1824607, lng: -3.6011675999999992, radiusKm: 10 },
  { match: /park\s*g(u|ü)ell|parc\s*g(u|ü)ell/i, label: 'Park Güell', sublabel: 'Hotels in Barcelona', searchAs: 'Barcelona', placeId: 'ChIJ5TCOcRaYpBIRCmZHTz37sEQ', lat: 41.387437399999996, lng: 2.1686495999999997, radiusKm: 10 },
  // --- Germany & Austria ---
  { match: /brandenburg\s*gate|brandenburger\s*tor/i, label: 'Brandenburg Gate', sublabel: 'Hotels in central Berlin', searchAs: 'Berlin', placeId: 'ChIJAVkDPzdOqEcRcDteW0YgIQQ', lat: 52.520006599999995, lng: 13.404954, radiusKm: 10 },
  { match: /neuschwanstein/i, label: 'Neuschwanstein Castle', sublabel: 'Hotels in Füssen · gateway to the castle', searchAs: 'Füssen', placeId: 'ChIJCfRmaIBfnEcRAPOL161IHgQ', lat: 47.569648, lng: 10.7004328, radiusKm: 10 },
  { match: /cologne\s*cathedral|k(o|ö)lner\s*dom/i, label: 'Cologne Cathedral', sublabel: 'Hotels in central Cologne', searchAs: 'Cologne', placeId: 'ChIJ5S-raZElv0cR8HcqSvxgJwQ', lat: 50.937531, lng: 6.9602786, radiusKm: 10 },
  { match: /sch(o|ö)nbrunn/i, label: 'Schönbrunn Palace', sublabel: 'Hotels in Vienna', searchAs: 'Vienna', placeId: 'ChIJn8o2UZ4HbUcRRluiUYrlwv0', lat: 48.208069599999995, lng: 16.3713095, radiusKm: 10 },
  // --- Netherlands ---
  { match: /anne\s*frank|rijksmuseum|van\s*gogh\s*museum/i, label: 'Amsterdam museums', sublabel: 'Hotels in central Amsterdam', searchAs: 'Amsterdam', placeId: 'ChIJVXealLU_xkcRja_At0z9AGY', lat: 52.3675734, lng: 4.9041388999999995, radiusKm: 10 },
  // --- Czech Republic ---
  { match: /prague\s*castle|charles\s*bridge|karl(u|ů)v\s*most/i, label: 'Prague Castle / Charles Bridge', sublabel: 'Hotels in central Prague', searchAs: 'Prague', placeId: 'ChIJi3lwCZyTC0cRkEAWZg-vAAQ', lat: 50.075538099999996, lng: 14.437800500000002, radiusKm: 10 },
  // --- Greece ---
  { match: /acropolis|parthenon/i, label: 'Acropolis', sublabel: 'Hotels in central Athens', searchAs: 'Athens', placeId: 'ChIJ8UNwBh-9oRQR3Y1mdkU1Nic', lat: 37.9838096, lng: 23.727538799999998, radiusKm: 10 },
  { match: /meteora/i, label: 'Meteora', sublabel: 'Hotels in Kalambaka · gateway to the monasteries', searchAs: 'Athens', placeId: 'ChIJeSx1tc8PWRMR-l8fWgNgo8A', lat: 39.706618, lng: 21.6288728, radiusKm: 10 },
  // --- Croatia ---
  { match: /plitvice/i, label: 'Plitvice Lakes', sublabel: 'Hotels at Plitvička Jezera · gateway to the park', searchAs: 'Zagreb', placeId: 'ChIJqX7IpYRnYUcRsMMrhlCtAAQ', lat: 44.8820957, lng: 15.6233311, radiusKm: 10 },
  // --- Russia ---
  { match: /red\s*square|kremlin/i, label: 'Red Square / Kremlin', sublabel: 'Hotels in central Moscow', searchAs: 'Moscow', placeId: 'ChIJybDUc_xKtUYRTM9XV8zWRD0', lat: 55.756872099999995, lng: 37.6150527, radiusKm: 10 },
  { match: /hermitage\s*museum|state\s*hermitage/i, label: 'Hermitage Museum', sublabel: 'Hotels in central Saint Petersburg', searchAs: 'Moscow', placeId: 'ChIJ7WVKx4w3lkYR_46Eqz9nx20', lat: 59.931058400000005, lng: 30.360909699999997, radiusKm: 10 },
  // --- Iceland & Nordics ---
  { match: /blue\s*lagoon/i, label: 'Blue Lagoon (Iceland)', sublabel: 'Hotels in Reykjavík · ~45 min drive', searchAs: 'Reykjavik', placeId: 'ChIJw-3c7rl01kgRcWDSMKIskew', lat: 64.1469868, lng: -21.940755199999998, radiusKm: 10 },
  { match: /northern\s*lights|aurora\s*borealis/i, label: 'Northern Lights (Tromsø)', sublabel: 'Hotels in Tromsø · prime aurora-viewing base', searchAs: 'Tromsø', placeId: 'ChIJ_XE7bFLExEUR075ujoXKPQI', lat: 69.6492047, lng: 18.9553238, radiusKm: 10 },
  // --- Turkey ---
  { match: /hagia\s*sophia|ayasofya/i, label: 'Hagia Sophia', sublabel: 'Hotels in central Istanbul (Sultanahmet)', searchAs: 'Istanbul', placeId: 'ChIJawhoAASnyhQR0LABvJj-zOE', lat: 41.0082376, lng: 28.9783589, radiusKm: 10 },
  { match: /blue\s*mosque|sultan\s*ahmed\s*mosque/i, label: 'Blue Mosque', sublabel: 'Hotels in central Istanbul (Sultanahmet)', searchAs: 'Istanbul', placeId: 'ChIJawhoAASnyhQR0LABvJj-zOE', lat: 41.0082376, lng: 28.9783589, radiusKm: 10 },
  { match: /cappadocia|kapadokya/i, label: 'Cappadocia', sublabel: 'Hotels in Göreme · centre of the region', searchAs: 'Göreme', placeId: 'ChIJq9Fr03loKhURUK4_ohdObEY', lat: 38.643056, lng: 34.828889, radiusKm: 10 },
  // --- UAE ---
  { match: /burj\s*al\s*arab/i, label: 'Burj Al Arab', sublabel: 'Hotels in Dubai', searchAs: 'Dubai', placeId: 'ChIJRcbZaklDXz4RYlEphFBu5r0', lat: 25.2048493, lng: 55.2707828, radiusKm: 10 },
  { match: /palm\s*jumeirah/i, label: 'Palm Jumeirah', sublabel: 'Hotels in Dubai', searchAs: 'Dubai', placeId: 'ChIJRcbZaklDXz4RYlEphFBu5r0', lat: 25.2048493, lng: 55.2707828, radiusKm: 10 },
  // --- Africa ---
  { match: /serengeti/i, label: 'Serengeti', sublabel: 'Hotels in Arusha · gateway to the parks', searchAs: 'Arusha', placeId: 'ChIJg3M48ogcNxgRUnFJ7PcHGbw', lat: -3.3869254, lng: 36.6829927, radiusKm: 100 },
  { match: /mount\s*kilimanjaro|kilimanjaro/i, label: 'Mount Kilimanjaro', sublabel: 'Hotels in Moshi · base for climbs', searchAs: 'Moshi', placeId: 'ChIJhWOFQ7TZORgRz7zYYwzVhBU', lat: -3.3486455, lng: 37.3435249, radiusKm: 75 },
  { match: /pyramids?\s*of\s*giza|great\s*pyramid/i, label: 'Pyramids of Giza', sublabel: 'Hotels in Giza · steps from the plateau', searchAs: 'Giza', placeId: 'ChIJl5ZXNZJGWBQRUvx4mB_WkU4', lat: 30.013055700000002, lng: 31.2088526, radiusKm: 10 },
  { match: /sahara\s*desert/i, label: 'Sahara Desert (Merzouga)', sublabel: 'Hotels & camps in Merzouga · Erg Chebbi dunes', searchAs: 'Merzouga', placeId: 'ChIJ5d80mCc8lw0RREretbL6OVY', lat: 31.0801676, lng: -4.013361, radiusKm: 75 },
  // --- China ---
  { match: /forbidden\s*city|imperial\s*palace\s*beijing/i, label: 'Forbidden City', sublabel: 'Hotels in central Beijing', searchAs: 'Beijing', placeId: 'ChIJuSwU55ZS8DURiqkPryBWYrk', lat: 39.904211, lng: 116.407395, radiusKm: 10 },
  { match: /great\s*wall\s*of\s*china|great\s*wall/i, label: 'Great Wall of China', sublabel: 'Hotels in Beijing · gateway to the wall', searchAs: 'Beijing', placeId: 'ChIJuSwU55ZS8DURiqkPryBWYrk', lat: 39.904211, lng: 116.407395, radiusKm: 10 },
  { match: /the\s*bund|shanghai\s*bund/i, label: 'The Bund (Shanghai)', sublabel: 'Hotels along the Bund · central Shanghai', searchAs: 'Shanghai', placeId: 'ChIJMzz1sUBwsjURoWTDI5QSlQI', lat: 31.230416, lng: 121.473701, radiusKm: 10 },
  { match: /hong\s*kong\s*skyline|victoria\s*peak/i, label: 'Hong Kong skyline', sublabel: 'Hotels in central Hong Kong', searchAs: 'Hong Kong', placeId: 'ChIJByjqov3-AzQR2pT0dDW0bUg', lat: 22.3193292, lng: 114.16942290000001, radiusKm: 10 },
  // --- Japan ---
  { match: /mount\s*fuji|mt\.?\s*fuji|fuji\s*san/i, label: 'Mount Fuji', sublabel: 'Hotels in Fujikawaguchiko · classic Fuji-view base', searchAs: 'Fujikawaguchiko', placeId: 'ChIJGyRHiGvgG2ARRmIMgHRWc1w', lat: 35.4973138, lng: 138.75519939999998, radiusKm: 10 },
  { match: /tokyo\s*tower/i, label: 'Tokyo Tower', sublabel: 'Hotels in central Tokyo', searchAs: 'Tokyo', placeId: 'ChIJXSModoWLGGARILWiCfeu2M0', lat: 35.680399699999995, lng: 139.7690174, radiusKm: 10 },
  { match: /senso(\s|-)?ji|asakusa\s*temple/i, label: 'Sensō-ji Temple', sublabel: 'Hotels in Asakusa · central Tokyo', searchAs: 'Tokyo', placeId: 'ChIJXSModoWLGGARILWiCfeu2M0', lat: 35.680399699999995, lng: 139.7690174, radiusKm: 10 },
  { match: /kyoto\s*bamboo|arashiyama\s*bamboo/i, label: 'Arashiyama Bamboo Forest', sublabel: 'Hotels in central Kyoto', searchAs: 'Kyoto', placeId: 'ChIJ8cM8zdaoAWARPR27azYdlsA', lat: 35.011564, lng: 135.7681489, radiusKm: 10 },
  // --- Southeast Asia ---
  { match: /petronas\s*towers/i, label: 'Petronas Twin Towers', sublabel: 'Hotels in central Kuala Lumpur (KLCC)', searchAs: 'Kuala Lumpur', placeId: 'ChIJ5-rvAcdJzDERfSgcL1uO2fQ', lat: 3.1499222, lng: 101.6944619, radiusKm: 10 },
  { match: /angkor\s*wat/i, label: 'Angkor Wat', sublabel: 'Hotels in Siem Reap · gateway to the temples', searchAs: 'Siem Reap', placeId: 'ChIJeaiRjJoWEDER-rvlPvmqQKk', lat: 13.3632533, lng: 103.856403, radiusKm: 10 },
  { match: /halong\s*bay|h(a|ạ)\s*long\s*bay/i, label: 'Halong Bay', sublabel: 'Hotels in Ha Long city', searchAs: 'Ha Long', placeId: 'ChIJBcqveDxXSjERAThbfWDP5Wc', lat: 20.941778499999998, lng: 107.1277751, radiusKm: 10 },
  { match: /^bali$|bali\s*indonesia|ubud|kuta\s*bali|seminyak/i, label: 'Bali', sublabel: 'Hotels in Denpasar · gateway to Bali', searchAs: 'Denpasar', placeId: 'ChIJ24BeDptA0i0RSje5zOg0c-I', lat: -8.6559348, lng: 115.21682309999998, radiusKm: 10 },
  // --- Singapore ---
  { match: /marina\s*bay\s*sands/i, label: 'Marina Bay Sands', sublabel: 'Hotels in central Singapore', searchAs: 'Singapore', placeId: 'ChIJyY4rtGcX2jERIKTarqz3AAQ', lat: 1.2811865999999998, lng: 103.8503404, radiusKm: 10 },
  { match: /sentosa\s*island|^sentosa$/i, label: 'Sentosa Island', sublabel: 'Hotels in Singapore', searchAs: 'Singapore', placeId: 'ChIJyY4rtGcX2jERIKTarqz3AAQ', lat: 1.2811865999999998, lng: 103.8503404, radiusKm: 10 },
  { match: /gardens?\s*by\s*the\s*bay/i, label: 'Gardens by the Bay', sublabel: 'Hotels in central Singapore', searchAs: 'Singapore', placeId: 'ChIJyY4rtGcX2jERIKTarqz3AAQ', lat: 1.2811865999999998, lng: 103.8503404, radiusKm: 10 },
  // --- Maldives ---
  { match: /^maldives$|maldives\s*islands/i, label: 'Maldives', sublabel: 'Hotels & resorts via Malé · Maldives gateway', searchAs: 'Malé', placeId: 'ChIJ5fXRB1Z-PzsRmRIFWpvp2Io', lat: 4.175270900000001, lng: 73.50911719999999, radiusKm: 10 },
  // --- Nepal ---
  { match: /mount\s*everest|mt\.?\s*everest|everest\s*base\s*camp/i, label: 'Mount Everest', sublabel: 'Hotels in Kathmandu · start of the trek', searchAs: 'Kathmandu', placeId: 'ChIJv6p7MIoZ6zkR6rGN8Rt8E7U', lat: 27.7103145, lng: 85.3221634, radiusKm: 150 },
  // --- India ---
  { match: /taj\s*mahal/i, label: 'Taj Mahal', sublabel: 'Hotels in Agra', searchAs: 'Agra', placeId: 'ChIJ2UEvfIUNdDkRQjtSqTjvSng', lat: 27.1766701, lng: 78.00807449999999, radiusKm: 10 },
  { match: /^goa$|goa\s*beach|north\s*goa/i, label: 'Goa', sublabel: 'Hotels in Calangute · North Goa beaches', searchAs: 'Calangute', placeId: 'ChIJ9Vm7fePBvzsRhscxtxGXD50', lat: 15.5456923, lng: 73.7607543, radiusKm: 10 },
  { match: /kerala\s*backwaters|alleppey|alappuzha/i, label: 'Kerala Backwaters', sublabel: 'Hotels in Alleppey · houseboats & lagoons', searchAs: 'Alleppey', placeId: 'ChIJYWspqvGECDsRWvhBLFVkR7g', lat: 9.498066699999999, lng: 76.3388484, radiusKm: 10 },
  // --- USA ---
  { match: /statue\s*of\s*liberty/i, label: 'Statue of Liberty', sublabel: 'Hotels in New York City', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 10 },
  { match: /empire\s*state\s*building/i, label: 'Empire State Building', sublabel: 'Hotels in midtown New York', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 10 },
  { match: /central\s*park\s*(new\s*york|nyc|ny)?|central\s*park\s*manhattan/i, label: 'Central Park', sublabel: 'Hotels near Central Park · NYC', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 10 },
  { match: /brooklyn\s*bridge/i, label: 'Brooklyn Bridge', sublabel: 'Hotels in New York City', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 10 },
  { match: /hollywood\s*sign|hollywood\s*walk/i, label: 'Hollywood Sign', sublabel: 'Hotels in Los Angeles', searchAs: 'Los Angeles', placeId: 'ChIJE9on3F3HwoAR9AhGJW_fL-I', lat: 34.0549076, lng: -118.24264299999999, radiusKm: 10 },
  { match: /white\s*house|capitol\s*hill/i, label: 'The White House', sublabel: 'Hotels in Washington D.C.', searchAs: 'Washington', placeId: 'ChIJW-T2Wt7Gt4kRKl2I1CJFUsI', lat: 38.9072873, lng: -77.0369274, radiusKm: 10 },
  { match: /mount\s*rushmore|mt\.?\s*rushmore/i, label: 'Mount Rushmore', sublabel: 'Hotels in Rapid City · 25 min from the monument', searchAs: 'Rapid City', placeId: 'ChIJ-6W7nqVCfYcRx7eTPlphccQ', lat: 44.080543399999996, lng: -103.2310149, radiusKm: 10 },
  { match: /walt\s*disney\s*world|disney\s*world|magic\s*kingdom|epcot/i, label: 'Walt Disney World', sublabel: 'Hotels in Orlando · Disney area', searchAs: 'Orlando', placeId: 'ChIJd7zN_thz54gRnr-lPAaywwo', lat: 28.5383832, lng: -81.3789269, radiusKm: 10 },
  { match: /disneyland\s*california|disneyland\s*ca|disneyland\s*anaheim/i, label: 'Disneyland California', sublabel: 'Hotels in Anaheim · Disneyland Resort area', searchAs: 'Anaheim', placeId: 'ChIJZ-hVgPnW3IARYLErmquJqwE', lat: 33.836593199999996, lng: -117.9143012, radiusKm: 10 },
  // --- Canada ---
  { match: /cn\s*tower/i, label: 'CN Tower', sublabel: 'Hotels in downtown Toronto', searchAs: 'Toronto', placeId: 'ChIJpTvG15DL1IkRd8S0KlBVNTI', lat: 43.6548253, lng: -79.388447, radiusKm: 10 },
  // --- South America ---
  { match: /christ\s*the\s*redeemer|cristo\s*redentor/i, label: 'Christ the Redeemer', sublabel: 'Hotels in Rio de Janeiro', searchAs: 'Rio de Janeiro', placeId: 'ChIJW6AIkVXemwARTtIvZ2xC3FA', lat: -22.9068467, lng: -43.1728965, radiusKm: 10 },
  { match: /iguazu\s*falls|igua(c|ç)u\s*falls/i, label: 'Iguazu Falls', sublabel: 'Hotels in Foz do Iguaçu · Brazilian side', searchAs: 'Foz do Iguaçu', placeId: 'ChIJQwpTruuQ9pQRUqnEtHOUlyE', lat: -25.516510099999998, lng: -54.585403, radiusKm: 10 },
  // --- Oceania ---
  { match: /great\s*barrier\s*reef/i, label: 'Great Barrier Reef', sublabel: 'Hotels in Cairns · gateway to the reef', searchAs: 'Cairns', placeId: 'ChIJEySiW1VieGkRYHggf_HuAAQ', lat: -16.920347600000003, lng: 145.7709529, radiusKm: 10 },
  { match: /uluru|ayers\s*rock/i, label: 'Uluru / Ayers Rock', sublabel: 'Hotels in Yulara · only base for the rock', searchAs: 'Yulara', placeId: 'ChIJPz2rao9AIysRAIUkKqgXAgQ', lat: -25.237979, lng: 130.9856199, radiusKm: 10 },
  { match: /hobbiton/i, label: 'Hobbiton', sublabel: 'Hotels in Matamata · gateway to the set', searchAs: 'Matamata', placeId: 'ChIJqRZ64SdObG0RsOGiQ2HvAAU', lat: -37.8084687, lng: 175.7709978, radiusKm: 10 },
  // === HIDDEN GEMS ===
  { match: /lake\s*bled|^bled$/i, label: 'Lake Bled', sublabel: 'Hotels in Bled · Slovenia\'s alpine lake', searchAs: 'Bled', placeId: 'ChIJYZkT1x2OekcRUOw_ghz4AAQ', lat: 46.3683266, lng: 14.114579800000001, radiusKm: 10 },
  { match: /lake\s*como/i, label: 'Lake Como', sublabel: 'Hotels in Como · northern Italy', searchAs: 'Como', placeId: 'ChIJY-0nEEichkcRJPVfeK-Wm7k', lat: 45.806381699999996, lng: 9.0851867, radiusKm: 10 },
  { match: /cinque\s*terre|riomaggiore|monterosso/i, label: 'Cinque Terre', sublabel: 'Hotels in Riomaggiore · one of the five villages', searchAs: 'Riomaggiore', placeId: 'ChIJB4uscYn61BIRgGX4h7QPnhE', lat: 44.100180099999996, lng: 9.7376008, radiusKm: 10 },
  { match: /faroe\s*islands/i, label: 'Faroe Islands', sublabel: 'Hotels in Tórshavn · capital of the Faroes', searchAs: 'Tórshavn', placeId: 'ChIJlUCZXxwuvEgRqSUCjJgJrt0', lat: 62.01072479999999, lng: -6.7740852, radiusKm: 10 },
  { match: /lofoten/i, label: 'Lofoten Islands', sublabel: 'Hotels in Svolvær · main Lofoten town', searchAs: 'Svolvær', placeId: 'ChIJUUNvFyKA3kURMw-2Z5beIIw', lat: 68.2343088, lng: 14.568223800000002, radiusKm: 10 },
  { match: /^madeira$|madeira\s*island|madeira\s*portugal/i, label: 'Madeira', sublabel: 'Hotels in Funchal · capital of Madeira', searchAs: 'Funchal', placeId: 'ChIJq4sfUMNfYAwROaHNFSxN2P8', lat: 32.6506129, lng: -16.9082357, radiusKm: 10 },
  { match: /^azores$|azores\s*islands/i, label: 'Azores', sublabel: 'Hotels in Ponta Delgada · main Azores city', searchAs: 'Ponta Delgada', placeId: 'ChIJlw6wdswqQwsRFsRvTvKAVXY', lat: 37.7394207, lng: -25.6686725, radiusKm: 10 },
  { match: /antelope\s*canyon|horseshoe\s*bend/i, label: 'Antelope Canyon', sublabel: 'Hotels in Page · gateway to the canyon', searchAs: 'Page', placeId: 'ChIJj3XN_VsTNIcROU44U1EvmG4', lat: 36.91472220000001, lng: -111.4558333, radiusKm: 75 },
  { match: /atacama\s*desert|atacama/i, label: 'Atacama Desert', sublabel: 'Hotels in San Pedro de Atacama', searchAs: 'San Pedro de Atacama', placeId: 'ChIJP78qqXpMqJYR0Zf5rExh9Ho', lat: -22.910198299999998, lng: -68.19836149999999, radiusKm: 75 },
  { match: /salar\s*de\s*uyuni|uyuni\s*salt\s*flats/i, label: 'Salar de Uyuni', sublabel: 'Hotels in Uyuni · gateway to the salt flats', searchAs: 'Uyuni', placeId: 'ChIJvfLTWNm6_5MRU2ZOLB6EVRQ', lat: -20.461817399999997, lng: -66.8215967, radiusKm: 75 },
  { match: /easter\s*island|rapa\s*nui/i, label: 'Easter Island', sublabel: 'Hotels in Hanga Roa · only town on the island', searchAs: 'Hanga Roa', placeId: 'ChIJFwoxLFP6R5kRDBoGLMq7qpU', lat: -27.148051799999998, lng: -109.42734019999999, radiusKm: 50 },
  { match: /gal(a|á)pagos/i, label: 'Galápagos Islands', sublabel: 'Hotels in Puerto Ayora · main Galápagos town', searchAs: 'Puerto Ayora', placeId: 'ChIJa7-U-0NdqpoRNWGGLDX6QZg', lat: -0.7433862999999999, lng: -90.3156597, radiusKm: 10 },
  { match: /^fiji$|fiji\s*islands/i, label: 'Fiji', sublabel: 'Hotels in Nadi · main Fiji gateway', searchAs: 'Nadi', placeId: 'ChIJUQgUUYtaF24RKNOlslOphx0', lat: -17.780625699999998, lng: 177.42989609999998, radiusKm: 10 },
  ...
  { match: /^boracay$|boracay\s*island/i, label: 'Boracay', sublabel: 'Hotels in Aklan · gateway to Boracay', searchAs: 'Aklan', placeId: 'ChIJkc4JNwA_pTMR9YmVzK8IcUw', lat: 11.9174474, lng: 121.9606581, radiusKm: 10 },
  { match: /annapurna|annapurna\s*circuit/i, label: 'Annapurna', sublabel: 'Hotels in Pokhara · base for the trek', searchAs: 'Pokhara', placeId: 'ChIJ_3YDv3uTlTkRZCGAJTuCz_Y', lat: 28.2095831, lng: 83.9855674, radiusKm: 10 },
  { match: /guilin\s*landscape|yangshuo|li\s*river/i, label: 'Guilin / Yangshuo', sublabel: 'Hotels in Yangshuo · karst landscape', searchAs: 'Yangshuo', placeId: 'ChIJZVKVEX6lpTYRBQDurljkC0c', lat: 24.778429900000003, lng: 110.49663, radiusKm: 10 },
  { match: /^bhutan$|paro\s*valley/i, label: 'Bhutan', sublabel: 'Hotels in Paro · gateway to Bhutan', searchAs: 'Paro', placeId: 'ChIJtzlsWuid4TkRkAEHWg94-gE', lat: 27.4283009, lng: 89.41695229999999, radiusKm: 10 },
  { match: /gili\s*islands?|gili\s*trawangan|^lombok$/i, label: 'Gili Islands / Lombok', sublabel: 'Hotels in Lombok · gateway to the Gilis', searchAs: 'Lombok', placeId: 'ChIJBzxUOeI4zC0R286ewj4py_s', lat: -8.5132429, lng: 116.666397, radiusKm: 10 },
];
          ...
          {q.length >= 2 && LANDMARK_ALIASES.filter(l => l.match.test(q)).map(l => (
            <li key={`landmark-${l.label}`}
              onMouseDown={() => {
                ...
                // "Disneyland" because they want Disneyland, not Paris.
                // Pass coords + radius through `onPlaceSelect` so /api/hotels
                // does a true LiteAPI radius search at the landmark spot
                // instead of the city-name fallback. Disneyland Paris's
                // 10 km radius around the park coords picks up the on-site
                // Disney resort hotels (Sequoia Lodge, Davy Crockett Ranch,
                // etc) — central-Paris hotels 50 km away no longer appear.
                onChange(l.label);
                onPlaceSelect({
                  id: l.placeId,
                  name: l.label,
...
function HotelsContent() {
  ...
  // Explicit radius (km) when a curated source (LANDMARK_ALIASES or
  // neighbourhood) wants to override the backend default of 15 km.
  // Disneyland Paris uses 10 km to keep results on the Disney resort
  // properties; Mount Everest uses 150 km so Kathmandu trekking hotels
  // surface. See LANDMARK_ALIASES.radiusKm + the RADIUS_OVERRIDES table
  // in scripts/merge-landmark-coords.mjs for the source of truth.
  const [selectedPlaceRadius, setSelectedPlaceRadius] = useState<number | null>(null);
  ...
  const handleSearch = useCallback(async () => {
    ...
    try {
      // Landmark fallback: if the typed destination matches a LANDMARK_ALIASES
      // regex (e.g. user typed "Eiffel Tower" but hit Enter without clicking
      // the dropdown row), use that landmark's `searchAs` city AND coords/
      // radius so /api/hotels does a proper radius search at the landmark
      ...
      const searchCity =
        landmarkMatch && trimmedDest.toLowerCase() !== landmarkMatch.searchAs.toLowerCase()
          ...
          : trimmedDest;
      // If the typed destination matched a landmark but the user didn't click
      // (so coords aren't in state), pull coords + radius from the alias.
      const fallbackCoords =
        landmarkMatch && !selectedPlaceCoords
          ? { lat: landmarkMatch.lat, lng: landmarkMatch.lng }
          : null;
      const fallbackRadius =
        landmarkMatch && !selectedPlaceRadius ? landmarkMatch.radiusKm : null;
      ...
      const effectiveRadius = selectedPlaceRadius || fallbackRadius;
      if (effectiveRadius) {
