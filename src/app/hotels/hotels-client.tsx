...
const LANDMARK_ALIASES: Array<{
  ...
  { match: /buckingham\s*palace/i, label: 'Buckingham Palace', sublabel: 'Hotels in central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 15 },
  { match: /london\s*eye/i, label: 'London Eye', sublabel: 'Hotels on the South Bank · central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 15 },
  { match: /tower\s*bridge/i, label: 'Tower Bridge', sublabel: 'Hotels in central London', searchAs: 'London', placeId: 'ChIJdd4hrwug2EcRmSrV3Vo6llI', lat: 51.5072178, lng: -0.12758619999999998, radiusKm: 15 },
  ...
  { match: /edinburgh\s*castle/i, label: 'Edinburgh Castle', sublabel: 'Hotels in central Edinburgh', searchAs: 'Edinburgh', placeId: 'ChIJIyaYpQC4h0gRJxfnfHsU8mQ', lat: 55.953252, lng: -3.1882669999999997, radiusKm: 15 },
  ...
  { match: /york\s*minster/i, label: 'York Minster', sublabel: 'Hotels in central York', searchAs: 'York', placeId: 'ChIJ8WWY4UDDeEgR0eRUiomrdEc', lat: 53.961420499999996, lng: -1.0739108, radiusKm: 15 },
  ...
  // --- France ---
  { match: /eiffel\s*tower|tour\s*eiffel/i, label: 'Eiffel Tower', sublabel: 'Hotels in central Paris', searchAs: 'Paris', placeId: 'ChIJD7fiBh9u5kcRYJSMaMOCCwQ', lat: 48.857547499999995, lng: 2.3513764999999998, radiusKm: 15 },
  // --- Italy ---
  { match: /colosseum|coliseum/i, label: 'Colosseum', sublabel: 'Hotels in central Rome', searchAs: 'Rome', placeId: 'ChIJu46S-ZZhLxMROG5lkwZ3D7k', lat: 41.8967068, lng: 12.4822025, radiusKm: 15 },
  { match: /trevi\s*fountain|fontana\s*di\s*trevi/i, label: 'Trevi Fountain', sublabel: 'Hotels in central Rome', searchAs: 'Rome', placeId: 'ChIJu46S-ZZhLxMROG5lkwZ3D7k', lat: 41.8967068, lng: 12.4822025, radiusKm: 15 },
  { match: /leaning\s*tower\s*of\s*pisa|tower\s*of\s*pisa/i, label: 'Leaning Tower of Pisa', sublabel: 'Hotels in Pisa', searchAs: 'Pisa', placeId: 'ChIJj1n28JqR1RIRyHiEp7UPuKo', lat: 43.722838499999995, lng: 10.4017581, radiusKm: 15 },
  // --- Spain ---
  ...
  // --- Netherlands ---
  { match: /anne\s*frank|rijksmuseum|van\s*gogh\s*museum/i, label: 'Amsterdam museums', sublabel: 'Hotels in central Amsterdam', searchAs: 'Amsterdam', placeId: 'ChIJVXealLU_xkcRja_At0z9AGY', lat: 52.3675734, lng: 4.9041388999999995, radiusKm: 15 },
  // --- Czech Republic ---
  ...
  // --- Turkey ---
  { match: /hagia\s*sophia|ayasofya/i, label: 'Hagia Sophia', sublabel: 'Hotels in central Istanbul (Sultanahmet)', searchAs: 'Istanbul', placeId: 'ChIJawhoAASnyhQR0LABvJj-zOE', lat: 41.0082376, lng: 28.9783589, radiusKm: 15 },
  { match: /blue\s*mosque|sultan\s*ahmed\s*mosque/i, label: 'Blue Mosque', sublabel: 'Hotels in central Istanbul (Sultanahmet)', searchAs: 'Istanbul', placeId: 'ChIJawhoAASnyhQR0LABvJj-zOE', lat: 41.0082376, lng: 28.9783589, radiusKm: 15 },
  { match: /cappadocia|kapadokya/i, label: 'Cappadocia', sublabel: 'Hotels in Göreme · centre of the region', searchAs: 'Göreme', placeId: 'ChIJq9Fr03loKhURUK4_ohdObEY', lat: 38.643056, lng: 34.828889, radiusKm: 15 },
  // --- UAE ---
  { match: /burj\s*al\s*arab/i, label: 'Burj Al Arab', sublabel: 'Hotels in Dubai', searchAs: 'Dubai', placeId: 'ChIJRcbZaklDXz4RYlEphFBu5r0', lat: 25.2048493, lng: 55.2707828, radiusKm: 15 },
  { match: /palm\s*jumeirah/i, label: 'Palm Jumeirah', sublabel: 'Hotels in Dubai', searchAs: 'Dubai', placeId: 'ChIJRcbZaklDXz4RYlEphFBu5r0', lat: 25.2048493, lng: 55.2707828, radiusKm: 15 },
  // --- Africa ---
  ...
  { match: /pyramids?\s*of\s*giza|great\s*pyramid/i, label: 'Pyramids of Giza', sublabel: 'Hotels in Giza · steps from the plateau', searchAs: 'Giza', placeId: 'ChIJl5ZXNZJGWBQRUvx4mB_WkU4', lat: 30.013055700000002, lng: 31.2088526, radiusKm: 15 },
  ...
  // --- China ---
  { match: /forbidden\s*city|imperial\s*palace\s*beijing/i, label: 'Forbidden City', sublabel: 'Hotels in central Beijing', searchAs: 'Beijing', placeId: 'ChIJuSwU55ZS8DURiqkPryBWYrk', lat: 39.904211, lng: 116.407395, radiusKm: 15 },
  { match: /great\s*wall\s*of\s*china|great\s*wall/i, label: 'Great Wall of China', sublabel: 'Hotels in Beijing · gateway to the wall', searchAs: 'Beijing', placeId: 'ChIJuSwU55ZS8DURiqkPryBWYrk', lat: 39.904211, lng: 116.407395, radiusKm: 15 },
  { match: /the\s*bund|shanghai\s*bund/i, label: 'The Bund (Shanghai)', sublabel: 'Hotels along the Bund · central Shanghai', searchAs: 'Shanghai', placeId: 'ChIJMzz1sUBwsjURoWTDI5QSlQI', lat: 31.230416, lng: 121.473701, radiusKm: 15 },
  { match: /hong\s*kong\s*skyline|victoria\s*peak/i, label: 'Hong Kong skyline', sublabel: 'Hotels in central Hong Kong', searchAs: 'Hong Kong', placeId: 'ChIJByjqov3-AzQR2pT0dDW0bUg', lat: 22.3193292, lng: 114.16942290000001, radiusKm: 15 },
  // --- Japan ---
  { match: /mount\s*fuji|mt\.?\s*fuji|fuji\s*san/i, label: 'Mount Fuji', sublabel: 'Hotels in Fujikawaguchiko · classic Fuji-view base', searchAs: 'Fujikawaguchiko', placeId: 'ChIJGyRHiGvgG2ARRmIMgHRWc1w', lat: 35.4973138, lng: 138.75519939999998, radiusKm: 15 },
  { match: /tokyo\s*tower/i, label: 'Tokyo Tower', sublabel: 'Hotels in central Tokyo', searchAs: 'Tokyo', placeId: 'ChIJXSModoWLGGARILWiCfeu2M0', lat: 35.680399699999995, lng: 139.7690174, radiusKm: 15 },
  { match: /senso(\s|-)?ji|asakusa\s*temple/i, label: 'Sensō-ji Temple', sublabel: 'Hotels in Asakusa · central Tokyo', searchAs: 'Tokyo', placeId: 'ChIJXSModoWLGGARILWiCfeu2M0', lat: 35.680399699999995, lng: 139.7690174, radiusKm: 15 },
  { match: /kyoto\s*bamboo|arashiyama\s*bamboo/i, label: 'Arashiyama Bamboo Forest', sublabel: 'Hotels in central Kyoto', searchAs: 'Kyoto', placeId: 'ChIJ8cM8zdaoAWARPR27azYdlsA', lat: 35.011564, lng: 135.7681489, radiusKm: 15 },
  // --- Southeast Asia ---
  { match: /petronas\s*towers/i, label: 'Petronas Twin Towers', sublabel: 'Hotels in central Kuala Lumpur (KLCC)', searchAs: 'Kuala Lumpur', placeId: 'ChIJ5-rvAcdJzDERfSgcL1uO2fQ', lat: 3.1499222, lng: 101.6944619, radiusKm: 15 },
  { match: /angkor\s*wat/i, label: 'Angkor Wat', sublabel: 'Hotels in Siem Reap · gateway to the temples', searchAs: 'Siem Reap', placeId: 'ChIJeaiRjJoWEDER-rvlPvmqQKk', lat: 13.3632533, lng: 103.856403, radiusKm: 15 },
  { match: /halong\s*bay|h(a|ạ)\s*long\s*bay/i, label: 'Halong Bay', sublabel: 'Hotels in Ha Long city', searchAs: 'Ha Long', placeId: 'ChIJBcqveDxXSjERAThbfWDP5Wc', lat: 20.941778499999998, lng: 107.1277751, radiusKm: 15 },
  { match: /^bali$|bali\s*indonesia|ubud|kuta\s*bali|seminyak/i, label: 'Bali', sublabel: 'Hotels in Denpasar · gateway to Bali', searchAs: 'Denpasar', placeId: 'ChIJ24BeDptA0i0RSje5zOg0c-I', lat: -8.6559348, lng: 115.21682309999998, radiusKm: 15 },
  // --- Singapore ---
  { match: /marina\s*bay\s*sands/i, label: 'Marina Bay Sands', sublabel: 'Hotels in central Singapore', searchAs: 'Singapore', placeId: 'ChIJyY4rtGcX2jERIKTarqz3AAQ', lat: 1.2811865999999998, lng: 103.8503404, radiusKm: 15 },
  { match: /sentosa\s*island|^sentosa$/i, label: 'Sentosa Island', sublabel: 'Hotels in Singapore', searchAs: 'Singapore', placeId: 'ChIJyY4rtGcX2jERIKTarqz3AAQ', lat: 1.2811865999999998, lng: 103.8503404, radiusKm: 15 },
  { match: /gardens?\s*by\s*the\s*bay/i, label: 'Gardens by the Bay', sublabel: 'Hotels in central Singapore', searchAs: 'Singapore', placeId: 'ChIJyY4rtGcX2jERIKTarqz3AAQ', lat: 1.2811865999999998, lng: 103.8503404, radiusKm: 15 },
  // --- Maldives ---
  { match: /^maldives$|maldives\s*islands/i, label: 'Maldives', sublabel: 'Hotels & resorts via Malé · Maldives gateway', searchAs: 'Malé', placeId: 'ChIJ5fXRB1Z-PzsRmRIFWpvp2Io', lat: 4.175270900000001, lng: 73.50911719999999, radiusKm: 15 },
  // --- Nepal ---
  ...
  // --- India ---
  { match: /taj\s*mahal/i, label: 'Taj Mahal', sublabel: 'Hotels in Agra', searchAs: 'Agra', placeId: 'ChIJ2UEvfIUNdDkRQjtSqTjvSng', lat: 27.1766701, lng: 78.00807449999999, radiusKm: 15 },
  { match: /^goa$|goa\s*beach|north\s*goa/i, label: 'Goa', sublabel: 'Hotels in Calangute · North Goa beaches', searchAs: 'Calangute', placeId: 'ChIJ9Vm7fePBvzsRhscxtxGXD50', lat: 15.5456923, lng: 73.7607543, radiusKm: 15 },
  { match: /kerala\s*backwaters|alleppey|alappuzha/i, label: 'Kerala Backwaters', sublabel: 'Hotels in Alleppey · houseboats & lagoons', searchAs: 'Alleppey', placeId: 'ChIJYWspqvGECDsRWvhBLFVkR7g', lat: 9.498066699999999, lng: 76.3388484, radiusKm: 15 },
  // --- USA ---
  { match: /statue\s*of\s*liberty/i, label: 'Statue of Liberty', sublabel: 'Hotels in New York City', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 15 },
  { match: /empire\s*state\s*building/i, label: 'Empire State Building', sublabel: 'Hotels in midtown New York', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 15 },
  { match: /central\s*park\s*(new\s*york|nyc|ny)?|central\s*park\s*manhattan/i, label: 'Central Park', sublabel: 'Hotels near Central Park · NYC', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 15 },
  { match: /brooklyn\s*bridge/i, label: 'Brooklyn Bridge', sublabel: 'Hotels in New York City', searchAs: 'New York', placeId: 'ChIJOwg_06VPwokRYv534QaPC8g', lat: 40.7127753, lng: -74.0059728, radiusKm: 15 },
  { match: /hollywood\s*sign|hollywood\s*walk/i, label: 'Hollywood Sign', sublabel: 'Hotels in Los Angeles', searchAs: 'Los Angeles', placeId: 'ChIJE9on3F3HwoAR9AhGJW_fL-I', lat: 34.0549076, lng: -118.24264299999999, radiusKm: 15 },
  { match: /white\s*house|capitol\s*hill/i, label: 'The White House', sublabel: 'Hotels in Washington D.C.', searchAs: 'Washington', placeId: 'ChIJW-T2Wt7Gt4kRKl2I1CJFUsI', lat: 38.9072873, lng: -77.0369274, radiusKm: 15 },
  { match: /mount\s*rushmore|mt\.?\s*rushmore/i, label: 'Mount Rushmore', sublabel: 'Hotels in Rapid City · 25 min from the monument', searchAs: 'Rapid City', placeId: 'ChIJ-6W7nqVCfYcRx7eTPlphccQ', lat: 44.080543399999996, lng: -103.2310149, radiusKm: 15 },
  { match: /walt\s*disney\s*world|disney\s*world|magic\s*kingdom|epcot/i, label: 'Walt Disney World', sublabel: 'Hotels in Orlando · Disney area', searchAs: 'Orlando', placeId: 'ChIJd7zN_thz54gRnr-lPAaywwo', lat: 28.5383832, lng: -81.3789269, radiusKm: 15 },
  { match: /disneyland\s*california|disneyland\s*ca|disneyland\s*anaheim/i, label: 'Disneyland California', sublabel: 'Hotels in Anaheim · Disneyland Resort area', searchAs: 'Anaheim', placeId: 'ChIJZ-hVgPnW3IARYLErmquJqwE', lat: 33.836593199999996, lng: -117.9143012, radiusKm: 15 },
  // --- Canada ---
  { match: /cn\s*tower/i, label: 'CN Tower', sublabel: 'Hotels in downtown Toronto', searchAs: 'Toronto', placeId: 'ChIJpTvG15DL1IkRd8S0KlBVNTI', lat: 43.6548253, lng: -79.388447, radiusKm: 15 },
  // --- South America ---
  { match: /christ\s*the\s*redeemer|cristo\s*redentor/i, label: 'Christ the Redeemer', sublabel: 'Hotels in Rio de Janeiro', searchAs: 'Rio de Janeiro', placeId: 'ChIJW6AIkVXemwARTtIvZ2xC3FA', lat: -22.9068467, lng: -43.1728965, radiusKm: 15 },
  { match: /iguazu\s*falls|igua(c|ç)u\s*falls/i, label: 'Iguazu Falls', sublabel: 'Hotels in Foz do Iguaçu · Brazilian side', searchAs: 'Foz do Iguaçu', placeId: 'ChIJQwpTruuQ9pQRUqnEtHOUlyE', lat: -25.516510099999998, lng: -54.585403, radiusKm: 15 },
  // --- Oceania ---
  { match: /great\s*barrier\s*reef/i, label: 'Great Barrier Reef', sublabel: 'Hotels in Cairns · gateway to the reef', searchAs: 'Cairns', placeId: 'ChIJEySiW1VieGkRYHggf_HuAAQ', lat: -16.920347600000003, lng: 145.7709529, radiusKm: 15 },
  { match: /uluru|ayers\s*rock/i, label: 'Uluru / Ayers Rock', sublabel: 'Hotels in Yulara · only base for the rock', searchAs: 'Yulara', placeId: 'ChIJPz2rao9AIysRAIUkKqgXAgQ', lat: -25.237979, lng: 130.9856199, radiusKm: 15 },
  { match: /hobbiton/i, label: 'Hobbiton', sublabel: 'Hotels in Matamata · gateway to the set', searchAs: 'Matamata', placeId: 'ChIJqRZ64SdObG0RsOGiQ2HvAAU', lat: -37.8084687, lng: 175.7709978, radiusKm: 15 },
  // === HIDDEN GEMS ===
  { match: /lake\s*bled|^bled$/i, label: 'Lake Bled', sublabel: 'Hotels in Bled · Slovenia\'s alpine lake', searchAs: 'Bled', placeId: 'ChIJYZkT1x2OekcRUOw_ghz4AAQ', lat: 46.3683266, lng: 14.114579800000001, radiusKm: 15 },
  { match: /lake\s*como/i, label: 'Lake Como', sublabel: 'Hotels in Como · northern Italy', searchAs: 'Como', placeId: 'ChIJY-0nEEichkcRJPVfeK-Wm7k', lat: 45.806381699999996, lng: 9.0851867, radiusKm: 15 },
  { match: /cinque\s*terre|riomaggiore|monterosso/i, label: 'Cinque Terre', sublabel: 'Hotels in Riomaggiore · one of the five villages', searchAs: 'Riomaggiore', placeId: 'ChIJB4uscYn61BIRgGX4h7QPnhE', lat: 44.100180099999996, lng: 9.7376008, radiusKm: 15 },
  { match: /faroe\s*islands/i, label: 'Faroe Islands', sublabel: 'Hotels in Tórshavn · capital of the Faroes', searchAs: 'Tórshavn', placeId: 'ChIJlUCZXxwuvEgRqSUCjJgJrt0', lat: 62.01072479999999, lng: -6.7740852, radiusKm: 15 },
  { match: /lofoten/i, label: 'Lofoten Islands', sublabel: 'Hotels in Svolvær · main Lofoten town', searchAs: 'Svolvær', placeId: 'ChIJUUNvFyKA3kURMw-2Z5beIIw', lat: 68.2343088, lng: 14.568223800000002, radiusKm: 15 },
  { match: /^madeira$|madeira\s*island|madeira\s*portugal/i, label: 'Madeira', sublabel: 'Hotels in Funchal · capital of Madeira', searchAs: 'Funchal', placeId: 'ChIJq4sfUMNfYAwROaHNFSxN2P8', lat: 32.6506129, lng: -16.9082357, radiusKm: 15 },
  { match: /^azores$|azores\s*islands/i, label: 'Azores', sublabel: 'Hotels in Ponta Delgada · main Azores city', searchAs: 'Ponta Delgada', placeId: 'ChIJlw6wdswqQwsRFsRvTvKAVXY', lat: 37.7394207, lng: -25.6686725, radiusKm: 15 },
  ...
  { match: /gal(a|á)pagos/i, label: 'Galápagos Islands', sublabel: 'Hotels in Puerto Ayora · main Galápagos town', searchAs: 'Puerto Ayora', placeId: 'ChIJa7-U-0NdqpoRNWGGLDX6QZg', lat: -0.7433862999999999, lng: -90.3156597, radiusKm: 15 },
        ...
        <div>
          ...
          {cheapest && (
            <section className="max-w-[1000px] mx-auto px-5 pt-2 sm:pt-8 pb-2 sm:pb-4">
              <div className="bg-gradient-to-r from-orange-50 to-amber-50 border border-orange-200 rounded-2xl px-4 py-3 sm:px-6 sm:py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1 sm:gap-2">
                <div className="flex items-center gap-2 sm:gap-3">
                  <span className="text-base sm:text-xl">🏷</span>
                  <span className="font-poppins font-black text-[.88rem] sm:text-[1rem] text-[#1A1D2B] leading-snug">
                ...
                <p className="text-[.62rem] sm:text-[.7rem] text-[#8E95A9] font-semibold leading-snug">{t('pricesRecentSearches')}</p>
              </div>
          ...
          {hotels!.length > 0 && (
            <section className="max-w-[1000px] mx-auto px-5 pb-2 sm:pb-3">
              <div className="flex flex-row flex-wrap items-center gap-1.5 sm:gap-3 sm:justify-between">
                {/* Filters — mobile only (lg has the sticky sidebar rail) */}
                <button
                  type="button"
                  onClick={() => setMobileFiltersOpen(true)}
                  className="lg:hidden inline-flex items-center gap-1.5 px-3 py-2 sm:px-4 sm:py-2.5 rounded-xl border border-[#E8ECF4] bg-white text-[.76rem] sm:text-[.82rem] font-bold text-[#1A1D2B] shadow-sm"
                >
                ...
                <div className="flex items-center gap-2">
                  ...
                  <select
                    ...
                    className="px-2.5 py-1.5 sm:px-3 sm:py-2 rounded-xl border border-[#E8ECF4] bg-white text-[.74rem] sm:text-[.8rem] font-bold text-[#1A1D2B] outline-none focus:border-orange-400 cursor-pointer"
                  >
