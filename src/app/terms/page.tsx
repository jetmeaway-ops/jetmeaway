...
export default function Terms() {
  return (
    <>
      <PageSchema crumbs={[{ name: 'Terms', path: '/terms' }]} />
      <Header />
      ...
      <div className="max-w-[760px] mx-auto px-5 pb-16">
        <div className="bg-white border border-[#F1F3F7] rounded-3xl p-8 text-[.85rem] text-[#5C6378] leading-relaxed space-y-1">
          ...
          <p>Questions about these Terms? Email <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold">contact@jetmeaway.co.uk</a>, call <a href="tel:+448006526699" className="text-[#0066FF] font-bold">0800 652 6699</a>, or visit our <a href="/contact" className="text-[#0066FF] font-bold">contact page</a>.</p>
        </div>
      </div>
      <Footer />
    </>
