...
/**
 * Italian blog index — /it/blog.
 *
 * Mirrors the English listing at src/app/blog/page.tsx; only the copy,
 * the date format and the card links differ. It exists so the Italian
 * articles have a real parent page: "Torna al blog" needs somewhere to
 * go, and Google needs a crawlable hub linking the 545 translations.
 *
 * Copy uses informal "tu", matching src/messages/it.json and the corpus —
 * the German sibling uses formal Sie, which must not be copied here.
 */

export const metadata = {
  title: 'Blog di viaggi | JetMeAway',
  description:
    'Consigli di viaggio, guide sulle destinazioni e trucchi dal tuo Scout di viaggi personale. I migliori hotel, voli, pacchetti e offerte eSIM per il 2026.',
  alternates: {
    canonical: 'https://jetmeaway.co.uk/it/blog',
    languages: {
  ...
  openGraph: {
    title: 'Blog di viaggi | JetMeAway',
    description:
      'Consigli di viaggio, guide sulle destinazioni e trucchi dal tuo Scout di viaggi personale.',
    url: 'https://jetmeaway.co.uk/it/blog',
    type: 'website',
    locale: 'it_IT',
  },
};

export default function ItalianBlogListingPage() {
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <h1 className="font-poppins text-[2.6rem] md:text-[3.8rem] font-black text-white leading-[1.05] tracking-tight mb-3 [text-shadow:0_2px_24px_rgba(0,0,0,0.45)]">
              Consigli e <em className="italic bg-gradient-to-br from-cyan-300 to-blue-400 bg-clip-text text-transparent">guide</em> di viaggio
            </h1>
            <p className="text-[1rem] text-white/85 font-semibold max-w-[560px] mx-auto [text-shadow:0_1px_12px_rgba(0,0,0,0.5)]">
              Idee fondate dal tuo Scout di viaggi personale — destinazioni, offerte e strategie per il 2026.
            </p>
          </div>
          ...
          {posts.length > 0 ? (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-[.7rem] text-[#8E95A9] font-semibold pt-3 border-t border-[#F1F3F7]">
                      <span>{formatPostDate(post.date, 'it')}</span>
            ...
            <div className="text-center py-20 text-[#8E95A9]">
              <p className="text-[.9rem] font-semibold">Non ci sono ancora articoli — torna presto.</p>
            </div>
          )}
        </div>
      </main>
