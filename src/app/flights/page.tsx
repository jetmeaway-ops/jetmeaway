  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-1/3 left-[42%] w-56 h-56 rounded-full bg-blue-500/[.14] blur-3xl pointer-events-none animate-blob-drift-c" />
        <div className="absolute top-1/2 right-[20%] w-40 h-40 rounded-full bg-cyan-400/[.10] blur-3xl pointer-events-none animate-blob-drift-a" />

        {/* Floating glass squares */}
        <div className="absolute top-32 right-[12%] w-48 h-48 rounded-2xl border border-cyan-300/20 bg-white/[.05] backdrop-blur-sm rotate-12 hidden md:block pointer-events-none shadow-[0_30px_60px_-25px_rgba(34,211,238,0.4)] animate-float-slow" />
        <div className="absolute bottom-20 left-[7%] w-36 h-36 rounded-2xl border border-sky-300/20 bg-white/[.05] backdrop-blur-sm -rotate-6 hidden md:block pointer-events-none shadow-[0_30px_60px_-25px_rgba(56,189,248,0.35)] animate-float-slow-reverse" />
        <div className="absolute top-[60%] right-[6%] w-20 h-20 rounded-xl border border-blue-300/20 bg-white/[.05] backdrop-blur-sm rotate-[18deg] hidden lg:block pointer-events-none animate-float-slow-reverse" />
        <div className="absolute top-[24%] left-[6%] w-16 h-16 rounded-xl border border-cyan-300/25 bg-white/[.05] backdrop-blur-sm -rotate-12 hidden lg:block pointer-events-none animate-float-slow" />

        {/* Star sparkles — like cabin lights at altitude */}
        <div className="absolute top-[28%] left-[28%] w-1.5 h-1.5 rounded-full bg-cyan-200/90 shadow-[0_0_12px_4px_rgba(165,243,252,0.6)] pointer-events-none animate-twinkle" />
