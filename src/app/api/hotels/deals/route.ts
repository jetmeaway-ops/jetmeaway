...
const ALL_DESTINATIONS: { city: string; country: string; flag: string; photo: string; tag?: string }[] = [
  ...
  { city: 'Antalya',    country: 'TR', flag: '🇹🇷', photo: 'https://images.unsplash.com/photo-1542314831-068cd1dbfeeb?w=480&h=320&fit=crop', tag: 'All Inclusive' },
  ...
  { city: 'Palma',      country: 'ES', flag: '🇪🇸', photo: 'https://images.unsplash.com/photo-1566073771259-6a8506099945?w=480&h=320&fit=crop' },
  ...
  { city: 'Hurghada',   country: 'EG', flag: '🇪🇬', photo: 'https://images.unsplash.com/photo-1520250497591-112f2f40a3f4?w=480&h=320&fit=crop', tag: 'Budget Gem' },
  ...
  // Set C
  { city: 'Dubai',      country: 'AE', flag: '🇦🇪', photo: 'https://images.unsplash.com/photo-1512453979798-5ea266f8880c?w=480&h=320&fit=crop', tag: 'Luxury' },
  { city: 'Amsterdam',  country: 'NL', flag: '🇳🇱', photo: 'https://images.unsplash.com/photo-1534351590666-13e3e96b5017?w=480&h=320&fit=crop', tag: 'City Break' },
  { city: 'Athens',     country: 'GR', flag: '🇬🇷', photo: 'https://images.unsplash.com/photo-1555993539-1732b0258235?w=480&h=320&fit=crop', tag: 'Culture' },
  { city: 'Prague',     country: 'CZ', flag: '🇨🇿', photo: 'https://images.unsplash.com/photo-1519677100203-a0e668c92439?w=480&h=320&fit=crop', tag: 'City Break' },
  { city: 'Bodrum',     country: 'TR', flag: '🇹🇷', photo: 'https://images.unsplash.com/photo-1601561999077-20d511d06aca?w=480&h=320&fit=crop', tag: 'Beach' },
  { city: 'Phuket',     country: 'TH', flag: '🇹🇭', photo: 'https://images.unsplash.com/photo-1589394815804-964ed0be2eb5?w=480&h=320&fit=crop', tag: 'Paradise' },
  { city: 'Santorini',  country: 'GR', flag: '🇬🇷', photo: 'https://images.unsplash.com/photo-1570077188670-e3a8d69ac5ff?w=480&h=320&fit=crop', tag: 'Romantic' },
  { city: 'Budapest',   country: 'HU', flag: '🇭🇺', photo: 'https://images.unsplash.com/photo-1549213783-8284d0336c4f?w=480&h=320&fit=crop', tag: 'Budget Gem' },
  { city: 'Maldives',   country: 'MV', flag: '🇲🇻', photo: 'https://images.unsplash.com/photo-1514282401047-d79a71a590e8?w=480&h=320&fit=crop', tag: 'Luxury' },
  { city: 'Nice',       country: 'FR', flag: '🇫🇷', photo: 'https://images.unsplash.com/photo-1491166617655-0723a0999cfc?w=480&h=320&fit=crop', tag: 'Riviera' },
];
