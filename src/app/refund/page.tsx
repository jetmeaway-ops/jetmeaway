        ...
        <div className="bg-white border border-[#F1F3F7] rounded-3xl p-8 text-[.85rem] text-[#5C6378] leading-relaxed space-y-1">
          ...
          <div className="mt-8 pt-6 border-t border-[#F1F3F7]">
            <p className="text-[.78rem] text-[#8E95A9]">
              For refund enquiries, contact us at <a href="mailto:contact@jetmeaway.co.uk" className="text-[#0066FF] font-bold">contact@jetmeaway.co.uk</a> or call <a href="tel:+448006526699" className="text-[#0066FF] font-bold">0800 652 6699</a> (free from UK).
            </p>
          </div>
        </div>
      </div>
