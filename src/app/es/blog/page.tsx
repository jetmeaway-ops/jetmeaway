 ...
 * the date format and the card links differ. It exists so the Spanish
 * articles have a real parent page: "Volver al blog" needs somewhere to
 * go, and Google needs a crawlable hub linking the 545 translations.
 *
 * Copy uses informal "tú", matching src/messages/es.json and the corpus —
 * the German sibling uses formal Sie, which must not be copied here.
 */

export const metadata = {
  title: 'Blog de viajes | JetMeAway',
  description:
    'Consejos de viaje, guías de destinos y trucos de tu Scout de viajes personal. Los mejores hoteles, vuelos, paquetes y ofertas de eSIM para 2026.',
  alternates: {
    canonical: 'https://jetmeaway.co.uk/es/blog',
    languages: {
  ...
  openGraph: {
    title: 'Blog de viajes | JetMeAway',
    description:
      'Consejos de viaje, guías de destinos y trucos de tu Scout de viajes personal.',
    url: 'https://jetmeaway.co.uk/es/blog',
    type: 'website',
    locale: 'es_ES',
  },
};

export default function SpanishBlogListingPage() {
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <h1 className="font-poppins text-[2.6rem] md:text-[3.8rem] font-black text-white leading-[1.05] tracking-tight mb-3 [text-shadow:0_2px_24px_rgba(0,0,0,0.45)]">
              Consejos y <em className="italic bg-gradient-to-br from-cyan-300 to-blue-400 bg-clip-text text-transparent">guías</em> de viaje
            </h1>
            <p className="text-[1rem] text-white/85 font-semibold max-w-[560px] mx-auto [text-shadow:0_1px_12px_rgba(0,0,0,0.5)]">
              Ideas fundamentadas de tu Scout de viajes personal — destinos, ofertas y estrategias para 2026.
            </p>
          </div>
          ...
          {posts.length > 0 ? (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-[.7rem] text-[#8E95A9] font-semibold pt-3 border-t border-[#F1F3F7]">
                      <span>{formatPostDate(post.date, 'es')}</span>
            ...
            <div className="text-center py-20 text-[#8E95A9]">
              <p className="text-[.9rem] font-semibold">Aún no hay artículos — vuelve pronto.</p>
            </div>
          )}
        </div>
      </main>
