  ...
  return (
    <>
      ...
      >
        ...
        <div className="absolute top-1/3 left-[42%] w-56 h-56 rounded-full bg-blue-400/[.14] blur-3xl pointer-events-none animate-blob-drift-c" />
        <div className="absolute top-1/2 right-[20%] w-40 h-40 rounded-full bg-cyan-500/[.10] blur-3xl pointer-events-none animate-blob-drift-a" />
        ...
        <div className="absolute bottom-20 left-[7%] w-36 h-36 rounded-2xl border border-indigo-300/20 bg-white/[.05] backdrop-blur-sm -rotate-6 hidden md:block pointer-events-none shadow-[0_30px_60px_-25px_rgba(99,102,241,0.35)] animate-float-slow-reverse" />
        ...
        {/* Sparkle dots — electric pulses */}
        <div className="absolute top-[28%] left-[28%] w-1.5 h-1.5 rounded-full bg-cyan-200/90 shadow-[0_0_12px_4px_rgba(165,243,252,0.65)] pointer-events-none animate-twinkle" />
