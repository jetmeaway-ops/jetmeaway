...
/**
 * German blog index — /de/blog.
 *
 * Mirrors the English listing at src/app/blog/page.tsx; only the copy,
 * the date format and the card links differ. It exists so the German
 * articles have a real parent page: "Zurück zum Blog" needs somewhere to
 * go, and Google needs a crawlable hub linking the 545 translations.
 */

export const metadata = {
  title: 'Reise-Blog | JetMeAway',
  description:
    'Reisetipps, Zielführer und Insider-Wissen von Ihrem persönlichen Reise-Scout. Die besten Hotels, Flüge, Pauschalreisen und eSIM-Angebote für 2026.',
  alternates: {
    canonical: 'https://jetmeaway.co.uk/de/blog',
    languages: {
  ...
  openGraph: {
    title: 'Reise-Blog | JetMeAway',
    description:
      'Reisetipps, Zielführer und Insider-Wissen von Ihrem persönlichen Reise-Scout.',
    url: 'https://jetmeaway.co.uk/de/blog',
    type: 'website',
    locale: 'de_DE',
  },
};

export default function GermanBlogListingPage() {
        ...
        <div className="max-w-[1200px] mx-auto">
          ...
          <div className="text-center mb-14">
            ...
            <h1 className="font-poppins text-[2.6rem] md:text-[3.8rem] font-black text-white leading-[1.05] tracking-tight mb-3 [text-shadow:0_2px_24px_rgba(0,0,0,0.45)]">
              Reisetipps & <em className="italic bg-gradient-to-br from-cyan-300 to-blue-400 bg-clip-text text-transparent">Ratgeber</em>
            </h1>
            <p className="text-[1rem] text-white/85 font-semibold max-w-[560px] mx-auto [text-shadow:0_1px_12px_rgba(0,0,0,0.5)]">
              Fundierte Einblicke von Ihrem persönlichen Reise-Scout — Ziele, Angebote und Strategien für 2026.
            </p>
          </div>
          ...
          {posts.length > 0 ? (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center justify-between text-[.7rem] text-[#8E95A9] font-semibold pt-3 border-t border-[#F1F3F7]">
                      <span>{formatPostDate(post.date, 'de')}</span>
            ...
            <div className="text-center py-20 text-[#8E95A9]">
              <p className="text-[.9rem] font-semibold">Noch keine Beiträge — schauen Sie bald wieder vorbei.</p>
            </div>
          )}
        </div>
      </main>
