...
heroImage: "https://images.unsplash.com/photo-1665413811870-5b29a250f64a?q=80&w=1600&h=800&fit=crop"
...
faqs:
  ...
  - q: "What time do Scotland's matches kick off in UK time?"
    a: "US Eastern Time is five hours behind the UK, so Boston and Miami evening kick-offs land late at night or close to midnight UK time. Check the exact FIFA-confirmed kick-off time for each fixture closer to the date, and if you're watching from home rather than travelling, expect a late one for all three group games."
  - q: "How do I get from Boston to Miami for the Scotland vs Brazil match?"
    a: "The simplest route is a short internal flight — around two and a half hours — from Boston Logan (BOS) to Miami International (MIA) or Fort Lauderdale–Hollywood (FLL). Compare fares on JetMeAway the same way you would a transatlantic leg, and book it as early as possible since internal capacity around match dates is squeezed by fans making the same journey."
  - q: "Do I need a visa or ESTA to travel to the USA for the World Cup?"
    a: "Most UK passport holders travel to the USA under the Visa Waiver Programme and need an approved ESTA (Electronic System for Travel Authorization) before flying, rather than a full visa. Apply online well ahead of your trip and make sure your passport has enough remaining validity — requirements can change, so check the official US government guidance close to your travel dates."
  - q: "What is the best area to stay in Boston for the Scotland matches?"
    a: "Central Boston — Back Bay, Beacon Hill, Downtown or the Seaport — is the strongest base, keeping you close to South Station for the MBTA's dedicated event trains out to Gillette Stadium in Foxborough. Our full [Boston hotel guide](/blog/best-hotels-boston-2026) ranks 49 real hotels across every price band, including budget options near Logan Airport from around £130 a night."
  - q: "What is the best area to stay in Miami for the Brazil match?"
    a: "Mid-Beach or Brickell are the two strongest bases for the Hard Rock Stadium fixture — Mid-Beach keeps you close to South Beach's nightlife, while Brickell is a more central, business-district option with easier access north to Miami Gardens. See the full [Miami hotel guide](/blog/best-hotels-miami-2026) for neighbourhood-by-neighbourhood picks across every budget."
  - q: "How much does a flight from the UK to Boston cost for the World Cup?"
    a: "Direct fares from Glasgow, Edinburgh or Heathrow to Boston Logan typically range from roughly £400 to £900 return depending on how far ahead you book, with prices climbing sharply as the 13 June opener approaches. Booking as early as possible and staying flexible on which UK airport you depart from are the two biggest levers for keeping the fare down."
  - q: "Is there a direct flight from Scotland to Boston or Miami?"
    a: "Yes for Boston — Glasgow and Edinburgh both have direct seasonal and scheduled links to the US East Coast, cutting out a London connection entirely. Miami direct services from Scotland are rarer; most Tartan Army fans will either connect via a UK hub or fly the Boston-to-Miami leg domestically once they're already in the US."
  - q: "What is the weather like in Boston and Miami during the group stage?"
    a: "Boston in mid-to-late June is warm and pleasant, typically 20-28°C, with occasional rain — pack a light layer for cooler evenings. Miami in late June is a different proposition entirely: heat indices regularly exceed 35°C with high humidity and routine afternoon thunderstorms, so an air-conditioned, well-located hotel is essential."
  - q: "Can I still get tickets for Scotland's World Cup matches?"
    a: "Ticket availability changes constantly and is managed exclusively through FIFA's official ticketing platform, not through JetMeAway or any other travel or comparison site. Register on FIFA's official channels for any remaining sales windows or resale opportunities, and treat any third-party seller offering 'guaranteed' Scotland tickets at a large markup with serious suspicion."
  - q: "Does JetMeAway sell World Cup match tickets?"
    a: "No. JetMeAway compares flights, hotels, car hire, eSIMs, insurance and holiday packages — match tickets are sold exclusively through FIFA's official platform and, for SFA members, the Scottish Football Association's supporters' club allocation. We focus on the travel and accommodation side of the trip, where our comparison tools genuinely add value."
  - q: "How many fans are expected to travel from Scotland for the 2026 World Cup?"
    a: "Exact numbers will only be confirmed closer to the tournament, but based on recent away-day and Euro 2024 travelling numbers — where roughly 200,000 Scottish fans travelled to Germany — a substantial five-figure Tartan Army contingent is expected across Boston and Miami, with the Boston charter-bus scheme alone expecting around 1,100 fans for the group games."
  - q: "What is the Group C draw and why is it tough for Scotland?"
    a: "Group C paired Scotland with five-time champions Brazil, 2022 semi-finalists Morocco, and a returning Haiti side. It is a demanding draw by any measure, but the expanded 48-team format means even a third-place finish can be enough to progress depending on how Scotland compare with other third-placed teams across the tournament — a cushion previous Scottish squads never had."
  - q: "Who are Scotland's toughest opponents in Group C?"
    a: "Brazil are the standout name and the five-time world champions, but Morocco — semi-finalists at the 2022 World Cup and a tactically disciplined, defensively strong side — are arguably the trickier tactical puzzle for Steve Clarke's team. Haiti are the side Scotland will be expected to beat, though underestimating a team playing their tournament final is the classic mistake to avoid."
  - q: "What is the FIFA-designated stadium name for Gillette Stadium during the World Cup?"
    a: "Gillette Stadium in Foxborough is officially called Boston Stadium on FIFA's tournament schedules and tickets, because the venue's regular corporate sponsor is not a tournament partner. Fans should expect to see 'Boston Stadium' on official documentation and 'Gillette Stadium' used interchangeably in everyday conversation and local signage."
  - q: "What is the FIFA-designated stadium name for Hard Rock Stadium during the World Cup?"
    a: "Hard Rock Stadium in Miami Gardens is officially called Miami Stadium on FIFA's non-commercial tournament naming convention. As with Boston, expect both names to be used — the official one on tickets and schedules, the familiar one in daily use and local wayfinding."
  - q: "How far is Gillette Stadium from central Boston?"
    a: "Gillette Stadium sits in Foxborough, roughly 25 miles south of downtown Boston — about 45 minutes by car in normal traffic, or 60-70 minutes via the MBTA's dedicated Foxboro commuter-rail event trains from South Station. There is no direct subway line to the stadium, so the event train or a chartered bus are the practical options on match day."
  - q: "How far is Hard Rock Stadium from South Beach?"
    a: "Hard Rock Stadium is in Miami Gardens, about 16 miles north of South Beach — roughly 25-35 minutes by car depending on traffic, which in Miami can be significant. Most fans base themselves in Mid-Beach or Brickell and use a rideshare or rental car to reach the stadium on match day."
  - q: "Should I book a package holiday instead of booking flights and hotels separately?"
    a: "It depends on your priorities. A holiday package bundling flights and hotel together, available through JetMeAway's [packages](/packages) comparison, adds a layer of financial protection and can simplify a straightforward single-city trip. For a multi-city Tartan Army itinerary spanning Boston and Miami with uncertain knockout-stage extensions, booking flights and hotels separately and keeping them refundable usually gives more flexibility."
  - q: "What should I do if Scotland reach the knockout rounds?"
    a: "Keep your group-stage flights and hotels refundable so you can extend without financial penalty, and monitor the bracket once Group C concludes. Likely knockout host cities for a Scotland run include New York/New Jersey, Atlanta, Dallas and Los Angeles — each has a dedicated JetMeAway hotel guide ([New York](/blog/best-hotels-new-york-2026), [Atlanta](/blog/best-hotels-atlanta-2026), [Dallas](/blog/best-hotels-dallas-2026), [Los Angeles](/blog/best-hotels-los-angeles-2026)) worth bookmarking in advance."
  - q: "Is Toronto or Mexico City relevant to Scotland's World Cup run?"
    a: "Only if Scotland advance deep into the knockout rounds, since both are outside Group C's fixed schedule. Toronto's BMO Field and Mexico City's Estadio Azteca are both plausible later-round venues depending on the bracket — see the [Toronto hotel guide](/blog/best-hotels-toronto-2026) and [Mexico City hotel guide](/blog/best-hotels-mexico-city-2026) if you want to plan a flexible, refundable contingency booking."
  - q: "What currency is used in Boston and Miami, and do UK cards work?"
    a: "Both cities use the US dollar. UK contactless debit and credit cards work almost everywhere, including on Boston's MBTA and Miami's transit, but check your bank's foreign transaction fee before you travel — a fee-free travel card can save a meaningful amount over a multi-city trip."
  - q: "Do I need travel insurance with sports cover for a World Cup trip?"
    a: "Yes, it's worth checking specifically. Many standard travel insurance policies exclude organised sporting events or have specific clauses around football tournament travel, so when comparing [travel insurance](/insurance) for a Scotland World Cup trip, check that your policy covers attending the matches themselves as well as the usual cancellation, medical and baggage protection."
  - q: "Will my UK mobile phone work in the USA without extra charges?"
    a: "Only if your provider includes US roaming in your plan, and even then data speeds and allowances can be limited. A dedicated travel eSIM, compared on JetMeAway's [eSIM page](/esim), gives you affordable local data the moment you land in Boston or Miami without needing to swap a physical SIM card or rely on patchy hotel wifi."
  - q: "What other UK teams are at the 2026 World Cup alongside Scotland?"
    a: "England also qualified for the 2026 World Cup and are grouped separately from Scotland. If you're planning to follow both home nations, or just want the full picture on England's tournament, read the Scout's companion guide: [England at the 2026 World Cup →](/blog/england-world-cup-2026)."
  - q: "How do I know if Scotland has qualified from the group before booking knockout travel?"
    a: "Scotland's final group match against Brazil is on 24 June 2026 in Miami, and qualification will be confirmed shortly after that final whistle once all Group C results and the wider 48-team standings are known. Hold off committing to non-refundable knockout-round travel until the group picture is fully clear, and favour refundable flights and hotels in the meantime so you can move fast once it is."
  - q: "Is the Tartan Army charter bus scheme open to all fans or only members?"
    a: "The organised charter bus scheme running from Rhode Island and downtown Boston to Gillette Stadium has been set up independently by fan groups rather than the SFA, and has generally been open to any travelling Scotland supporter rather than restricted to official Tartan Army membership. Details, routes and booking links are typically shared through Tartan Army fan forums and social channels closer to each match date."
---
...
![A lone footballer at the centre of a floodlit pitch — the high-stakes drama of tournament football that Scotland are returning to after 28 years.](https://images.unsplash.com/photo-1517927033932-b3d18e61fb3a?q=80&w=1400&fit=crop)
...
**Jump to:** [Football's Scottish roots](#football-origins) · [World Cup history](#wc-history) · [Iconic moments](#iconic-moments) · [Has Scotland won it?](#ever-won) · [Hampden Park](#hampden-park) · [The World Cup itself](#wc-itself) · [2026 tournament facts](#2026-facts) · [Where Scotland play](#fixtures-hosts) · [Hotel guides](#hotel-guides) · [The 2026 squad](#squad) · [Tickets & fixtures](#tickets-fixtures) · [Booking the trip](#booking-guide) · [Budget tips](#budget-tips) · [Sample itinerary](#sample-trip) · [The Tartan Army](#tartan-army) · [Why JetMeAway](#why-jetmeaway) · [FAQ](#faq)
...
<a id="football-origins"></a>

## Football in Scotland: How a Small Nation Shaped the Game

![A football pitch marked out on green grass — the simple geometry the Scottish 'combination game' would teach the rest of the world to use.](https://images.unsplash.com/photo-1564833592193-3270b5618e7f?q=80&w=1400&fit=crop)
...
![Football boots resting beside a ball on the grass — the kit of a game Scottish coaches helped export to every continent.](https://images.unsplash.com/photo-1511886929837-354d827aae26?q=80&w=1400&fit=crop)
...
![A player in mid-stride on the pitch — the kind of individual moment that Archie Gemmill's 1978 slalom past the Dutch defence turned into Scottish folklore.](https://images.unsplash.com/photo-1543326727-cf6c39e8f84c?q=80&w=1400&fit=crop)
...
![A modern football stadium under the lights — the cauldrons where Scotland's 28-year wait was lived out, one qualifying campaign after another.](https://images.unsplash.com/photo-1577214251108-5b352680130b?q=80&w=1400&fit=crop)
...
![A vast crowd packed onto the terraces, scarves and flags held high — the kind of scenes that turn World Cup moments into Scottish folklore.](https://images.unsplash.com/photo-1665413811870-5b29a250f64a?q=80&w=1400&fit=crop)
...
![A golden trophy gleaming on the pitch — the prize Scotland have never lifted, and realistically will not in 2026, but the one the country is finally chasing again.](https://images.unsplash.com/photo-1637203727317-3cc1a557cdbf?q=80&w=1400&fit=crop)
...
![Hampden Park, Glasgow — the spiritual home of Scottish football and the venue where the 28-year drought finally ended on 18 November 2025.](https://commons.wikimedia.org/wiki/Special:FilePath/Hampden_Park.jpg?width=1400)
...
![A football and a gold trophy side by side on the turf — the prize at the heart of every World Cup.](https://images.unsplash.com/photo-1527871252447-4ce32da643c6?q=80&w=1400&fit=crop)
...
![A floodlit football match in a packed stadium at night — the atmosphere awaiting Tartan Army fans across North America in 2026.](https://images.unsplash.com/photo-1706675780107-7c43cc487928?q=80&w=1400&fit=crop)
...
![Boston's skyline across the water — a compact, historic host city with strong direct links from the UK and the base for Scotland's first two group games.](https://images.unsplash.com/photo-1565127803082-69dd82351360?q=80&w=1400&fit=crop)
...
![Miami's waterfront high-rises against the blue Atlantic — host of the Scotland vs Brazil group decider at Hard Rock Stadium on 24 June 2026.](https://images.unsplash.com/photo-1558951412-8845d2b0f2fc?q=80&w=1400&fit=crop)
...
![The Brooklyn Bridge and the New York City skyline — the region whose MetLife Stadium hosts the 2026 World Cup final and the dream knockout destination for any Scotland run.](https://images.unsplash.com/photo-1496588152823-86ff7695e68f?q=80&w=1400&fit=crop)
...
A deeper run could theoretically take Scotland to Canada — **Toronto** (BMO Field) or **Vancouver** (BC Place) — or to Mexico. Both Canadian cities are clean, safe, easy-to-navigate destinations with strong direct UK flight links and make a lovely, less frantic alternative to the US host cities; check the FCDO's [Canada travel advice](https://www.gov.uk/foreign-travel-advice/canada) for entry rules before booking a cross-border leg. [Toronto World Cup hotels →](/blog/best-hotels-toronto-2026) · [Vancouver World Cup hotels →](/blog/best-hotels-vancouver-2026). Mexican host city hotels — including the historic Mexico City — are also covered: [Mexico City World Cup hotels →](/blog/best-hotels-mexico-city-2026).

<a id="hotel-guides"></a>

## Where to Stay: 2026 World Cup City-by-City Hotel Guides

![An aerial view of a modern stadium set within its city — the kind of venue dotted across all 16 host cities, with hotels nearby that fill fast on match days.](https://images.unsplash.com/photo-1670966482487-6a7f835bf813?q=80&w=1400&fit=crop)
...
![A football resting on green grass — the simple object the 2026 Scotland squad will spend the next six weeks chasing across North America.](https://images.unsplash.com/photo-1579952363873-27f3bade9f55?q=80&w=1400&fit=crop)
...
![A footballer surging forward with the ball — the kind of individual brilliance that Scott McTominay has brought to the modern Scotland midfield.](https://images.unsplash.com/photo-1577214251108-5b352680130b?q=80&w=1400&fit=crop)
...
![A passport and travel kit laid out ready to go — sort your ESTA and entry requirements well before you fly to follow Scotland.](https://images.unsplash.com/photo-1578894381163-e72c17f2d45f?q=80&w=1400&fit=crop)
...
<a id="booking-guide"></a>

## How to Follow Scotland at the 2026 World Cup — Booking the Whole Trip

![A plane wing over the clouds, seen from the window seat — the start of every Tartan Army adventure across the Atlantic.](https://images.unsplash.com/photo-1527605158555-853f200063e9?q=80&w=1400&fit=crop)
...
![A traveller planning a route on a map — Boston to Miami is a short hop, but a knockout run could send Scotland across a continent.](https://images.unsplash.com/photo-1524850011238-e3d235c7d4c9?q=80&w=1400&fit=crop)
...
A World Cup trip is a significant investment, and US healthcare in particular is famously expensive without cover. Travel insurance protects you against cancellations, medical costs, lost baggage and the disruptions that long, multi-city trips can throw at you. Sports cover for football fixtures is worth checking; many standard policies exclude organised sporting events. [Compare travel insurance →](/insurance). It's also worth reading the FCDO's [USA travel advice](https://www.gov.uk/foreign-travel-advice/usa) for entry requirements and the latest guidance before you fly.

### Step 6: Build the holiday around the football

![The Golden Gate Bridge and the open West Coast — between matches, build in the bucket-list America most fans cross an ocean for.](https://images.unsplash.com/photo-1521747116042-5a810fda9664?q=80&w=1400&fit=crop)
...
![Palm trees and a sun-soaked skyline — the contrast a Tartan Army member will feel arriving in Miami for the Brazil decider after Boston.](https://images.unsplash.com/photo-1597982087634-9884f03198ce?q=80&w=1400&fit=crop)
...
![Supporters in full voice, scarves and flags held high — the travelling army that has followed Scotland for generations.](https://images.unsplash.com/photo-1651608589821-82b047ae56bd?q=80&w=1400&fit=crop)
...
![A flag held aloft in a sea of supporters — the colours that will fill Boston and Miami this June and July.](https://images.unsplash.com/photo-1559559404-aa6a607570a7?q=80&w=1400&fit=crop)
...
![A vast crowd packs a stadium under the lights — the scenes Tartan Army members are dreaming of in the summer of 2026.](https://images.unsplash.com/photo-1569863959165-56dae551d4fc?q=80&w=1400&fit=crop)
...
### What time do Scotland's matches kick off in UK time?

US Eastern Time is five hours behind the UK, so Boston and Miami evening kick-offs land late at night or close to midnight UK time. Check the exact FIFA-confirmed kick-off time for each fixture closer to the date, and if you're watching from home rather than travelling, expect a late one for all three group games.

### How do I get from Boston to Miami for the Scotland vs Brazil match?

The simplest route is a short internal flight — around two and a half hours — from Boston Logan (BOS) to Miami International (MIA) or Fort Lauderdale–Hollywood (FLL). Compare fares on JetMeAway the same way you would a transatlantic leg, and book it as early as possible since internal capacity around match dates is squeezed by fans making the same journey.

### Do I need a visa or ESTA to travel to the USA for the World Cup?

Most UK passport holders travel to the USA under the Visa Waiver Programme and need an approved ESTA (Electronic System for Travel Authorization) before flying, rather than a full visa. Apply online well ahead of your trip and make sure your passport has enough remaining validity — requirements can change, so check the official US government guidance close to your travel dates.

### What is the best area to stay in Boston for the Scotland matches?

Central Boston — Back Bay, Beacon Hill, Downtown or the Seaport — is the strongest base, keeping you close to South Station for the MBTA's dedicated event trains out to Gillette Stadium in Foxborough. Our full [Boston hotel guide](/blog/best-hotels-boston-2026) ranks 49 real hotels across every price band, including budget options near Logan Airport from around £130 a night.

### What is the best area to stay in Miami for the Brazil match?

Mid-Beach or Brickell are the two strongest bases for the Hard Rock Stadium fixture — Mid-Beach keeps you close to South Beach's nightlife, while Brickell is a more central, business-district option with easier access north to Miami Gardens. See the full [Miami hotel guide](/blog/best-hotels-miami-2026) for neighbourhood-by-neighbourhood picks across every budget.

### How much does a flight from the UK to Boston cost for the World Cup?

Direct fares from Glasgow, Edinburgh or Heathrow to Boston Logan typically range from roughly £400 to £900 return depending on how far ahead you book, with prices climbing sharply as the 13 June opener approaches. Booking as early as possible and staying flexible on which UK airport you depart from are the two biggest levers for keeping the fare down.

### Is there a direct flight from Scotland to Boston or Miami?

Yes for Boston — Glasgow and Edinburgh both have direct seasonal and scheduled links to the US East Coast, cutting out a London connection entirely. Miami direct services from Scotland are rarer; most Tartan Army fans will either connect via a UK hub or fly the Boston-to-Miami leg domestically once they're already in the US.

### What is the weather like in Boston and Miami during the group stage?

Boston in mid-to-late June is warm and pleasant, typically 20-28°C, with occasional rain — pack a light layer for cooler evenings. Miami in late June is a different proposition entirely: heat indices regularly exceed 35°C with high humidity and routine afternoon thunderstorms, so an air-conditioned, well-located hotel is essential.

### Can I still get tickets for Scotland's World Cup matches?

Ticket availability changes constantly and is managed exclusively through FIFA's official ticketing platform, not through JetMeAway or any other travel or comparison site. Register on FIFA's official channels for any remaining sales windows or resale opportunities, and treat any third-party seller offering "guaranteed" Scotland tickets at a large markup with serious suspicion.

### Does JetMeAway sell World Cup match tickets?

No. JetMeAway compares flights, hotels, car hire, eSIMs, insurance and holiday packages — match tickets are sold exclusively through FIFA's official platform and, for SFA members, the Scottish Football Association's supporters' club allocation. We focus on the travel and accommodation side of the trip, where our comparison tools genuinely add value.

### How many fans are expected to travel from Scotland for the 2026 World Cup?

Exact numbers will only be confirmed closer to the tournament, but based on recent away-day and Euro 2024 travelling numbers — where roughly 200,000 Scottish fans travelled to Germany — a substantial five-figure Tartan Army contingent is expected across Boston and Miami, with the Boston charter-bus scheme alone expecting around 1,100 fans for the group games.

### What is the Group C draw and why is it tough for Scotland?

Group C paired Scotland with five-time champions Brazil, 2022 semi-finalists Morocco, and a returning Haiti side. It is a demanding draw by any measure, but the expanded 48-team format means even a third-place finish can be enough to progress depending on how Scotland compare with other third-placed teams across the tournament — a cushion previous Scottish squads never had.

### Who are Scotland's toughest opponents in Group C?

Brazil are the standout name and the five-time world champions, but Morocco — semi-finalists at the 2022 World Cup and a tactically disciplined, defensively strong side — are arguably the trickier tactical puzzle for Steve Clarke's team. Haiti are the side Scotland will be expected to beat, though underestimating a team playing their tournament final is the classic mistake to avoid.

### What is the FIFA-designated stadium name for Gillette Stadium during the World Cup?

Gillette Stadium in Foxborough is officially called Boston Stadium on FIFA's tournament schedules and tickets, because the venue's regular corporate sponsor is not a tournament partner. Fans should expect to see "Boston Stadium" on official documentation and "Gillette Stadium" used interchangeably in everyday conversation and local signage.

### What is the FIFA-designated stadium name for Hard Rock Stadium during the World Cup?

Hard Rock Stadium in Miami Gardens is officially called Miami Stadium on FIFA's non-commercial tournament naming convention. As with Boston, expect both names to be used — the official one on tickets and schedules, the familiar one in daily use and local wayfinding.

### How far is Gillette Stadium from central Boston?

Gillette Stadium sits in Foxborough, roughly 25 miles south of downtown Boston — about 45 minutes by car in normal traffic, or 60-70 minutes via the MBTA's dedicated Foxboro commuter-rail event trains from South Station. There is no direct subway line to the stadium, so the event train or a chartered bus are the practical options on match day.

### How far is Hard Rock Stadium from South Beach?

Hard Rock Stadium is in Miami Gardens, about 16 miles north of South Beach — roughly 25-35 minutes by car depending on traffic, which in Miami can be significant. Most fans base themselves in Mid-Beach or Brickell and use a rideshare or rental car to reach the stadium on match day.

### Should I book a package holiday instead of booking flights and hotels separately?

It depends on your priorities. A holiday package bundling flights and hotel together, available through JetMeAway's [packages](/packages) comparison, adds a layer of financial protection and can simplify a straightforward single-city trip. For a multi-city Tartan Army itinerary spanning Boston and Miami with uncertain knockout-stage extensions, booking flights and hotels separately and keeping them refundable usually gives more flexibility.

### What should I do if Scotland reach the knockout rounds?

Keep your group-stage flights and hotels refundable so you can extend without financial penalty, and monitor the bracket once Group C concludes. Likely knockout host cities for a Scotland run include New York/New Jersey, Atlanta, Dallas and Los Angeles — each has a dedicated JetMeAway hotel guide ([New York](/blog/best-hotels-new-york-2026), [Atlanta](/blog/best-hotels-atlanta-2026), [Dallas](/blog/best-hotels-dallas-2026), [Los Angeles](/blog/best-hotels-los-angeles-2026)) worth bookmarking in advance.

### Is Toronto or Mexico City relevant to Scotland's World Cup run?

Only if Scotland advance deep into the knockout rounds, since both are outside Group C's fixed schedule. Toronto's BMO Field and Mexico City's Estadio Azteca are both plausible later-round venues depending on the bracket — see the [Toronto hotel guide](/blog/best-hotels-toronto-2026) and [Mexico City hotel guide](/blog/best-hotels-mexico-city-2026) if you want to plan a flexible, refundable contingency booking.

### What currency is used in Boston and Miami, and do UK cards work?

Both cities use the US dollar. UK contactless debit and credit cards work almost everywhere, including on Boston's MBTA and Miami's transit, but check your bank's foreign transaction fee before you travel — a fee-free travel card can save a meaningful amount over a multi-city trip.

### Do I need travel insurance with sports cover for a World Cup trip?

Yes, it's worth checking specifically. Many standard travel insurance policies exclude organised sporting events or have specific clauses around football tournament travel, so when comparing [travel insurance](/insurance) for a Scotland World Cup trip, check that your policy covers attending the matches themselves as well as the usual cancellation, medical and baggage protection.

### Will my UK mobile phone work in the USA without extra charges?

Only if your provider includes US roaming in your plan, and even then data speeds and allowances can be limited. A dedicated travel eSIM, compared on JetMeAway's [eSIM page](/esim), gives you affordable local data the moment you land in Boston or Miami without needing to swap a physical SIM card or rely on patchy hotel wifi.

### What other UK teams are at the 2026 World Cup alongside Scotland?

England also qualified for the 2026 World Cup and are grouped separately from Scotland. If you're planning to follow both home nations, or just want the full picture on England's tournament, read the Scout's companion guide: [England at the 2026 World Cup →](/blog/england-world-cup-2026).

### How do I know if Scotland has qualified from the group before booking knockout travel?

Scotland's final group match against Brazil is on 24 June 2026 in Miami, and qualification will be confirmed shortly after that final whistle once all Group C results and the wider 48-team standings are known. Hold off committing to non-refundable knockout-round travel until the group picture is fully clear, and favour refundable flights and hotels in the meantime so you can move fast once it is.

### Is the Tartan Army charter bus scheme open to all fans or only members?

The organised charter bus scheme running from Rhode Island and downtown Boston to Gillette Stadium has been set up independently by fan groups rather than the SFA, and has generally been open to any travelling Scotland supporter rather than restricted to official Tartan Army membership. Details, routes and booking links are typically shared through Tartan Army fan forums and social channels closer to each match date.
