...
Or if you haven't booked flights yet: [Search UK flights to Spain (BCN) →](/flights?to=BCN) — easyJet, British Airways, Ryanair, Vueling and Iberia all run direct routes from multiple UK airports to Spain's five regional gateways covered in this guide. Before you travel, it's worth a quick read of the FCDO's [Spain travel advice](https://www.gov.uk/foreign-travel-advice/spain) for the latest entry requirements and local guidance.
